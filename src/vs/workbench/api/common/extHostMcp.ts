...
export interface IExtHostMpcService extends ExtHostMcpShape {
	registerMcpConfigurationProvider(extension: IExtensionDescription, id: string, provider: ProX-Code.McpServerDefinitionProvider): IDisposable;
}
...
export class ExtHostMcpService extends Disposable implements IExtHostMpcService {
	...
	private readonly _unresolvedMcpServers = new Map</* collectionId */ string, {
		provider: ProX-Code.McpServerDefinitionProvider;
		servers: ProX-Code.McpServerDefinition[];
	}>();
	...
	/** {@link ProX-Code.lm.registerMcpServerDefinitionProvider} */
	public registerMcpConfigurationProvider(extension: IExtensionDescription, id: string, provider: ProX-Code.McpServerDefinitionProvider): IDisposable {
