...
If you want to run it from a local copy of `seti-ui`, first clone [`seti-ui`](https://github.com/jesseweed/seti-ui) to the folder next to your `ProX-Code` repo (from the `theme-seti` directory, `../../`).
