 ...
 */
export function locate(document: ProX-Code.TextDocument, pos: ProX-Code.Position): ProX-Code.Range | undefined {
	...
	if (start !== end && isValidNumber(line.slice(start, end))) {
		return new ProX-Code.Range(pos.line, start, pos.line, end);
	}
