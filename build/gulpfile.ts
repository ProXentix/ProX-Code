...
const cleanClientTask = task.define('clean-client', util.rimraf('out'));
gulp.task(cleanClientTask);

const transpileClientSWCTask = task.define('transpile-client-esbuild', transpileTask('src', 'out', true));
gulp.task(transpileClientSWCTask);

// Transpile only
const transpileClientTask = task.define('transpile-client', transpileTask('src', 'out'));
