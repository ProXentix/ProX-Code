...
suite('ExtHostWebview', () => {
	...
	test('Cannot register multiple serializers for the same view type', async () => {
		...
		let lastInvokedDeserializer: ProX-Code.WebviewPanelSerializer | undefined = undefined;

		class NoopSerializer implements ProX-Code.WebviewPanelSerializer {
			async deserializeWebviewPanel(webview: ProX-Code.WebviewPanel, _state: any): Promise<void> {
	...
	test('asWebviewUri for local file paths', () => {
		...
		assert.strictEqual(
			...
			`https://file%2B.ProX-Code-resource.${webviewResourceBaseHost}/Users/codey/file.html`,
			'Unix basic'
		);

		assert.strictEqual(
			(webview.webview.asWebviewUri(URI.parse('file:///Users/codey/file.html#frag')).toString()),
			`https://file%2B.ProX-Code-resource.${webviewResourceBaseHost}/Users/codey/file.html#frag`,
			'Unix should preserve fragment'
		);

		assert.strictEqual(
			(webview.webview.asWebviewUri(URI.parse('file:///Users/codey/f%20ile.html')).toString()),
			`https://file%2B.ProX-Code-resource.${webviewResourceBaseHost}/Users/codey/f%20ile.html`,
			'Unix with encoding'
		);

		assert.strictEqual(
			(webview.webview.asWebviewUri(URI.parse('file://localhost/Users/codey/file.html')).toString()),
			`https://file%2Blocalhost.ProX-Code-resource.${webviewResourceBaseHost}/Users/codey/file.html`,
			'Unix should preserve authority'
		);

		assert.strictEqual(
			(webview.webview.asWebviewUri(URI.parse('file:///c:/codey/file.txt')).toString()),
			`https://file%2B.ProX-Code-resource.${webviewResourceBaseHost}/c%3A/codey/file.txt`,
			'Windows C drive'
		);
	});
	...
	test('asWebviewUri for remote file paths', () => {
		...
		assert.strictEqual(
			(webview.webview.asWebviewUri(URI.parse('file:///Users/codey/file.html')).toString()),
			`https://ProX-Code-remote%2Bremote.ProX-Code-resource.${webviewResourceBaseHost}/Users/codey/file.html`,
			'Unix basic'
		);
	});
	...
	test('asWebviewUri for remote with / and + in name', () => {
		...
		assert.strictEqual(
			webviewUri.toString(),
			`https://ProX-Code-remote%2Bssh-002dremote-002blocalhost-003dfoo-002fbar.ProX-Code-resource.ProX-Code-cdn.net/Users/cody/x.png`,
			'Check transform');

		assert.strictEqual(
			decodeAuthority(webviewUri.authority),
			`ProX-Code-remote+${authority}.ProX-Code-resource.ProX-Code-cdn.net`,
	...
	test('asWebviewUri for remote with port in name', () => {
		...
		assert.strictEqual(
			webviewUri.toString(),
			`https://ProX-Code-remote%2Blocalhost-003a8080.ProX-Code-resource.ProX-Code-cdn.net/Users/cody/x.png`,
			'Check transform');
