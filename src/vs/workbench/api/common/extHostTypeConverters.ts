...
export namespace Command {
	...
	export interface ICommandsConverter {
		fromInternal(command: extHostProtocol.ICommandDto): ProX-Code.Command | undefined;
		toInternal(command: ProX-Code.Command | undefined, disposables: DisposableStore): extHostProtocol.ICommandDto | undefined;
	}
}
...
export namespace Location {
	...
	export function from(location: ProX-Code.Location): Dto<languages.Location> {
		return {
			uri: location.uri,
	...
	export function to(location: Dto<languages.Location>): ProX-Code.Location {
...
export namespace Position {
	...
	export function from(position: types.Position | ProX-Code.Position): IPosition {
...
export namespace DocumentSelector {
	...
	export function from(value: ProX-Code.DocumentSelector, uriTransformer?: IURITransformer, extension?: IExtensionDescription): extHostProtocol.IDocumentFilterDto[] {
		return coalesce(asArray(value).map(sel => _doTransformDocumentSelector(sel, uriTransformer, extension)));
	}

	function _doTransformDocumentSelector(selector: string | ProX-Code.DocumentFilter, uriTransformer: IURITransformer | undefined, extension: IExtensionDescription | undefined): extHostProtocol.IDocumentFilterDto | undefined {
...
export namespace DiagnosticTag {
	export function from(value: ProX-Code.DiagnosticTag): MarkerTag | undefined {
		switch (value) {
	...
	export function to(value: MarkerTag): ProX-Code.DiagnosticTag | undefined {
		switch (value) {
...
export namespace Diagnostic {
	export function from(value: ProX-Code.Diagnostic): IMarkerData {
	...
	export function to(value: IMarkerData): ProX-Code.Diagnostic {
...
export namespace DiagnosticRelatedInformation {
	export function from(value: ProX-Code.DiagnosticRelatedInformation): IRelatedInformation {
		return {
...
export namespace ViewColumn {
	export function from(column?: ProX-Code.ViewColumn): EditorGroupColumn {
	...
	export function to(position: EditorGroupColumn): ProX-Code.ViewColumn {
...
function isDecorationOptions(something: any): something is ProX-Code.DecorationOptions {
	return (typeof something.range !== 'undefined');
}

export function isDecorationOptionsArr(something: ProX-Code.Range[] | ProX-Code.DecorationOptions[]): something is ProX-Code.DecorationOptions[] {
...
export namespace MarkdownString {
	...
	export function fromMany(markup: (ProX-Code.MarkdownString | ProX-Code.MarkedString)[]): htmlContent.IMarkdownString[] {
	...
	export function from(markup: ProX-Code.MarkdownString | ProX-Code.MarkedString): htmlContent.IMarkdownString {
	...
	export function to(value: htmlContent.IMarkdownString): ProX-Code.MarkdownString {
	...
	export function fromStrict(value: string | ProX-Code.MarkdownString | undefined | null): undefined | string | htmlContent.IMarkdownString {
		if (!value) {
			return undefined;
		}
...
export function fromRangeOrRangeWithMessage(ranges: ProX-Code.Range[] | ProX-Code.DecorationOptions[]): IDecorationOptions[] {
...
export namespace ThemableDecorationAttachmentRenderOptions {
	export function from(options: ProX-Code.ThemableDecorationAttachmentRenderOptions): IContentDecorationRenderOptions {
...
export namespace ThemableDecorationRenderOptions {
	export function from(options: ProX-Code.ThemableDecorationRenderOptions): IThemeDecorationRenderOptions {
		if (typeof options === 'undefined') {
			return options;
		}
		return {
...
export namespace DecorationRenderOptions {
	export function from(options: ProX-Code.DecorationRenderOptions): IDecorationRenderOptions {
		return {
...
export namespace TextEdit {
	...
	export function from(edit: ProX-Code.TextEdit): languages.TextEdit {
		return {
			text: edit.newText,
...
export namespace WorkspaceEdit {
	...
	export function from(value: ProX-Code.WorkspaceEdit, versionInfo?: IVersionInformationProvider): extHostProtocol.IWorkspaceEditDto {
...
export namespace SymbolKind {
	...
	export function from(kind: ProX-Code.SymbolKind): languages.SymbolKind {
		return typeof _fromMapping[kind] === 'number' ? _fromMapping[kind] : languages.SymbolKind.Property;
	}

	export function to(kind: languages.SymbolKind): ProX-Code.SymbolKind {
...
export namespace WorkspaceSymbol {
	export function from(info: ProX-Code.SymbolInformation): search.IWorkspaceSymbol {
		return {
			name: info.name,
...
export namespace DocumentSymbol {
	export function from(info: ProX-Code.DocumentSymbol): languages.DocumentSymbol {
	...
	export function to(info: languages.DocumentSymbol): ProX-Code.DocumentSymbol {
...
export namespace CallHierarchyItem {
	...
	export function from(item: ProX-Code.CallHierarchyItem, sessionId?: string, itemId?: string): extHostProtocol.ICallHierarchyItemDto {
...
export namespace location {
	export function from(value: ProX-Code.Location): languages.Location {
		return {
...
export namespace DefinitionLink {
	export function from(value: ProX-Code.Location | ProX-Code.DefinitionLink): languages.LocationLink {
		const definitionLink = <ProX-Code.DefinitionLink>value;
		const location = <ProX-Code.Location>value;
		return {
	...
	export function to(value: extHostProtocol.ILocationLinkDto): ProX-Code.LocationLink {
		return {
...
export namespace Hover {
	export function from(hover: ProX-Code.VerboseHover): languages.Hover {
...
export namespace EvaluatableExpression {
	export function from(expression: ProX-Code.EvaluatableExpression): languages.EvaluatableExpression {
		return {
...
export namespace InlineValue {
	export function from(inlineValue: ProX-Code.InlineValue): languages.InlineValue {
	...
	export function to(inlineValue: languages.InlineValue): ProX-Code.InlineValue {
		switch (inlineValue.type) {
			case 'text':
				return {
					range: Range.to(inlineValue.range),
					text: inlineValue.text
				} satisfies ProX-Code.InlineValueText;
			case 'variable':
				return {
					range: Range.to(inlineValue.range),
					variableName: inlineValue.variableName,
					caseSensitiveLookup: inlineValue.caseSensitiveLookup
				} satisfies ProX-Code.InlineValueVariableLookup;
			case 'expression':
				return {
					range: Range.to(inlineValue.range),
					expression: inlineValue.expression
				} satisfies ProX-Code.InlineValueEvaluatableExpression;
		}
	}
}

export namespace InlineValueContext {
	export function from(inlineValueContext: ProX-Code.InlineValueContext): extHostProtocol.IInlineValueContextDto {
		return {
...
export namespace DocumentHighlight {
	export function from(documentHighlight: ProX-Code.DocumentHighlight): languages.DocumentHighlight {
		return {
...
export namespace MultiDocumentHighlight {
	export function from(multiDocumentHighlight: ProX-Code.MultiDocumentHighlight): languages.MultiDocumentHighlight {
		return {
...
export namespace InlayHint {
	...
	export function to(converter: Command.ICommandsConverter, hint: languages.InlayHint): ProX-Code.InlayHint {
...
export namespace InlayHintKind {
	export function from(kind: ProX-Code.InlayHintKind): languages.InlayHintKind {
		return kind;
	}
	export function to(kind: languages.InlayHintKind): ProX-Code.InlayHintKind {
		return kind;
	}
}
...
export namespace DocumentLink {
	...
	export function from(link: ProX-Code.DocumentLink): languages.ILink {
		return {
	...
	export function to(link: languages.ILink): ProX-Code.DocumentLink {
...
export namespace ColorPresentation {
	...
	export function from(colorPresentation: ProX-Code.ColorPresentation): languages.IColorPresentation {
		return {
...
export namespace SelectionRange {
	export function from(obj: ProX-Code.SelectionRange): languages.SelectionRange {
		return { range: Range.from(obj.range) };
	}

	export function to(obj: languages.SelectionRange): ProX-Code.SelectionRange {
...
export namespace TextDocumentSaveReason {
	...
	export function to(reason: SaveReason): ProX-Code.TextDocumentSaveReason {
		switch (reason) {
...
export namespace TextEditorLineNumbersStyle {
	export function from(style: ProX-Code.TextEditorLineNumbersStyle): RenderLineNumbersType {
		switch (style) {
	...
	export function to(style: RenderLineNumbersType): ProX-Code.TextEditorLineNumbersStyle {
		switch (style) {
...
export namespace EndOfLine {
	...
	export function from(eol: ProX-Code.EndOfLine): EndOfLineSequence | undefined {
	...
	export function to(eol: EndOfLineSequence): ProX-Code.EndOfLine | undefined {
...
export namespace ProgressLocation {
	export function from(loc: ProX-Code.ProgressLocation | { viewId: string }): MainProgressLocation | string {
...
export namespace FoldingRange {
	export function from(r: ProX-Code.FoldingRange): languages.FoldingRange {
	...
	export function to(r: languages.FoldingRange): ProX-Code.FoldingRange {
		const range: ProX-Code.FoldingRange = { start: r.start - 1, end: r.end - 1 };
		if (r.kind) {
...
export namespace FoldingRangeKind {
	export function from(kind: ProX-Code.FoldingRangeKind | undefined): languages.FoldingRangeKind | undefined {
		if (kind) {
			switch (kind) {
	...
	export function to(kind: languages.FoldingRangeKind | undefined): ProX-Code.FoldingRangeKind | undefined {
		if (kind) {
			switch (kind.value) {
...
export interface TextEditorOpenOptions extends ProX-Code.TextDocumentShowOptions {
	background?: boolean;
	override?: boolean;
}
...
export namespace GlobPattern {
	...
	export function from(pattern: ProX-Code.GlobPattern): string | extHostProtocol.IRelativePatternDto;
	export function from(pattern: undefined): undefined;
	export function from(pattern: null): null;
	export function from(pattern: ProX-Code.GlobPattern | undefined | null): string | extHostProtocol.IRelativePatternDto | undefined | null;
	export function from(pattern: ProX-Code.GlobPattern | undefined | null): string | extHostProtocol.IRelativePatternDto | undefined | null {
		...
		// `ProX-Code.GlobPattern` which can be `ProX-Code.RelativePattern` class,
		// but given we cannot enforce classes from our ProX-Code.d.ts, we have
		// to probe for objects too
		// Refs: https://github.com/microsoft/ProX-Code/issues/140771
	...
	function isLegacyRelativePatternShape(obj: unknown): obj is { base: string; pattern: string } {
		...
		// we allow this old format when creating the `ProX-Code.RelativePattern`.
	...
	export function to(pattern: string | extHostProtocol.IRelativePatternDto): ProX-Code.GlobPattern {
		if (typeof pattern === 'string') {
			return pattern;
		}
...
export namespace LanguageSelector {
	...
	export function from(selector: ProX-Code.DocumentSelector): languageSelector.LanguageSelector;
	export function from(selector: ProX-Code.DocumentSelector | undefined): languageSelector.LanguageSelector | undefined;
	export function from(selector: ProX-Code.DocumentSelector | undefined): languageSelector.LanguageSelector | undefined {
		if (!selector) {
			return undefined;
...
export namespace NotebookRange {
	...
	export function from(range: ProX-Code.NotebookRange): ICellRange {
...
export namespace NotebookCellExecutionSummary {
	export function to(data: notebooks.NotebookCellInternalMetadata): ProX-Code.NotebookCellExecutionSummary {
		return {
	...
	export function from(data: ProX-Code.NotebookCellExecutionSummary): Partial<notebooks.NotebookCellInternalMetadata> {
		return {
...
export namespace NotebookCellKind {
	export function from(data: ProX-Code.NotebookCellKind): notebooks.CellKind {
		switch (data) {
	...
	export function to(data: notebooks.CellKind): ProX-Code.NotebookCellKind {
		switch (data) {
...
export namespace NotebookData {
	...
	export function from(data: ProX-Code.NotebookData): extHostProtocol.NotebookDataDto {
	...
	export function to(data: extHostProtocol.NotebookDataDto): ProX-Code.NotebookData {
...
export namespace NotebookCellData {
	...
	export function from(data: ProX-Code.NotebookCellData): extHostProtocol.NotebookCellDataDto {
		return {
	...
	export function to(data: extHostProtocol.NotebookCellDataDto): ProX-Code.NotebookCellData {
...
export namespace NotebookCellOutput {
	export function from(output: ProX-Code.NotebookCellOutput): extHostProtocol.NotebookOutputDto {
		return {
			outputId: output.id,
	...
	export function to(output: extHostProtocol.NotebookOutputDto): ProX-Code.NotebookCellOutput {
...
export namespace NotebookExclusiveDocumentPattern {
	export function from(pattern: { include: ProX-Code.GlobPattern | undefined; exclude: ProX-Code.GlobPattern | undefined }): { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined };
	export function from(pattern: ProX-Code.GlobPattern): string | extHostProtocol.IRelativePatternDto;
	export function from(pattern: undefined): undefined;
	export function from(pattern: { include: ProX-Code.GlobPattern | undefined | null; exclude: ProX-Code.GlobPattern | undefined } | ProX-Code.GlobPattern | undefined): string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined } | undefined;
	export function from(pattern: { include: ProX-Code.GlobPattern | undefined | null; exclude: ProX-Code.GlobPattern | undefined } | ProX-Code.GlobPattern | undefined): string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto | undefined; exclude: string | extHostProtocol.IRelativePatternDto | undefined } | undefined {
	...
	export function to(pattern: string | extHostProtocol.IRelativePatternDto | { include: string | extHostProtocol.IRelativePatternDto; exclude: string | extHostProtocol.IRelativePatternDto }): { include: ProX-Code.GlobPattern; exclude: ProX-Code.GlobPattern } | ProX-Code.GlobPattern {
		if (isExclusivePattern(pattern)) {
			return {
...
export namespace NotebookStatusBarItem {
	export function from(item: ProX-Code.NotebookCellStatusBarItem, commandsConverter: Command.ICommandsConverter, disposables: DisposableStore): notebooks.INotebookCellStatusBarItem {
...
export namespace NotebookKernelSourceAction {
	export function from(item: ProX-Code.NotebookKernelSourceAction, commandsConverter: Command.ICommandsConverter, disposables: DisposableStore): notebooks.INotebookKernelSourceAction {
		const command = typeof item.command === 'string' ? { title: '', command: item.command } : item.command;
...
export namespace NotebookDocumentContentOptions {
	export function from(options: ProX-Code.NotebookDocumentContentOptions | undefined): notebooks.TransientOptions {
		return {
...
export namespace NotebookRendererScript {
	export function from(preload: ProX-Code.NotebookRendererScript): { uri: UriComponents; provides: readonly string[] } {
		return {
			uri: preload.uri,
	...
	export function to(preload: { uri: UriComponents; provides: readonly string[] }): ProX-Code.NotebookRendererScript {
		return new types.NotebookRendererScript(URI.revive(preload.uri), preload.provides);
	}
}

export namespace TestMessage {
	export function from(message: ProX-Code.TestMessage): ITestErrorMessage.Serialized {
		return {
	...
	export function to(item: ITestErrorMessage.Serialized): ProX-Code.TestMessage {
...
export namespace TestRunProfileKind {
	const profileGroupToBitset: { [K in ProX-Code.TestRunProfileKind]: TestRunProfileBitset } = {
...
export namespace TestItem {
	export type Raw = ProX-Code.TestItem;

	export function from(item: ProX-Code.TestItem): ITestItem {
	...
	export function toPlain(item: ITestItem.Serialized): ProX-Code.TestItem {
		return {
			parent: undefined,
			error: undefined,
...
export namespace TestTag {
	export function from(tag: ProX-Code.TestTag): ITestTag {
		return { id: tag.id };
	}

	export function to(tag: ITestTag): ProX-Code.TestTag {
		return new types.TestTag(tag.id);
	}
}

export namespace TestResults {
	const convertTestResultItem = (node: IPrefixTreeNode<TestResultItem.Serialized>, parent?: ProX-Code.TestResultSnapshot): ProX-Code.TestResultSnapshot | undefined => {
		const item = node.value;
		if (!item) {
			return undefined; // should be unreachable
		}

		const snapshot: ProX-Code.TestResultSnapshot = ({
	...
	export function to(serialized: ISerializedTestResults): ProX-Code.TestRunResult {
...
export namespace TestCoverage {
	function fromCoverageCount(count: ProX-Code.TestCoverageCount): ICoverageCount {
		return { covered: count.covered, total: count.total };
	}

	function fromLocation(location: ProX-Code.Range | ProX-Code.Position) {
	...
	export function to(serialized: CoverageDetails.Serialized): ProX-Code.FileCoverageDetail {
		if (serialized.type === DetailType.Statement) {
			const branches: ProX-Code.BranchCoverage[] = [];
	...
	export function fromDetails(coverage: ProX-Code.FileCoverageDetail): CoverageDetails.Serialized {
	...
	export function fromFile(controllerId: string, id: string, coverage: ProX-Code.FileCoverage): IFileCoverage.Serialized {
...
export namespace TypeHierarchyItem {
	...
	export function from(item: ProX-Code.TypeHierarchyItem, sessionId?: string, itemId?: string): extHostProtocol.ITypeHierarchyItemDto {
...
export namespace ViewBadge {
	export function from(badge: ProX-Code.ViewBadge | undefined): IViewBadge | undefined {
		if (!badge) {
			return undefined;
		}
...
export namespace DataTransferItem {
	...
	export async function from(mime: string, item: ProX-Code.DataTransferItem | IDataTransferItem, id: string = generateUuid()): Promise<extHostProtocol.DataTransferItemDTO> {
...
export namespace DataTransfer {
	...
	export async function from(dataTransfer: ProX-Code.DataTransfer): Promise<extHostProtocol.DataTransferDTO> {
...
export namespace ChatFollowup {
	export function from(followup: ProX-Code.ChatFollowup, request: IChatAgentRequest | undefined): IChatFollowup {
		return {
			kind: 'reply',
	...
	export function to(followup: IChatFollowup): ProX-Code.ChatFollowup {
		return {
...
export namespace LanguageModelChatMessageRole {
	export function to(role: chatProvider.ChatMessageRole): ProX-Code.LanguageModelChatMessageRole {
		switch (role) {
	...
	export function from(role: ProX-Code.LanguageModelChatMessageRole): chatProvider.ChatMessageRole {
		switch (role) {
...
export namespace LanguageModelChatMessage {
	...
	export function to(message: chatProvider.IChatMessage): ProX-Code.LanguageModelChatMessage {
	...
	export function from(message: ProX-Code.LanguageModelChatMessage): chatProvider.IChatMessage {
...
export namespace LanguageModelChatMessage2 {
	...
	export function to(message: chatProvider.IChatMessage): ProX-Code.LanguageModelChatMessage2 {
		const content = message.content.map(c => {
			if (c.type === 'text') {
				return new LanguageModelTextPart(c.value);
			} else if (c.type === 'tool_result') {
	...
	export function from(message: ProX-Code.LanguageModelChatMessage2): chatProvider.IChatMessage {
...
export namespace ChatResponseMarkdownPart {
	export function from(part: ProX-Code.ChatResponseMarkdownPart): Dto<IChatMarkdownContent> {
		return {
			kind: 'markdownContent',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatMarkdownContent>): ProX-Code.ChatResponseMarkdownPart {
		return new types.ChatResponseMarkdownPart(MarkdownString.to(part.content));
	}
}

export namespace ChatResponseCodeblockUriPart {
	export function from(part: ProX-Code.ChatResponseCodeblockUriPart): Dto<IChatResponseCodeblockUriPart> {
		return {
			kind: 'codeblockUri',
			uri: part.value,
			isEdit: part.isEdit,
	...
	export function to(part: Dto<IChatResponseCodeblockUriPart>): ProX-Code.ChatResponseCodeblockUriPart {
...
export namespace ChatResponseMarkdownWithVulnerabilitiesPart {
	export function from(part: ProX-Code.ChatResponseMarkdownWithVulnerabilitiesPart): Dto<IChatAgentMarkdownContentWithVulnerability> {
		return {
			kind: 'markdownVuln',
			content: MarkdownString.from(part.value),
	...
	export function to(part: Dto<IChatAgentMarkdownContentWithVulnerability>): ProX-Code.ChatResponseMarkdownWithVulnerabilitiesPart {
...
export namespace ChatResponseConfirmationPart {
	export function from(part: ProX-Code.ChatResponseConfirmationPart): Dto<IChatConfirmation> {
		return {
			kind: 'confirmation',
			title: part.title,
...
export namespace ChatResponseFilesPart {
	export function from(part: ProX-Code.ChatResponseFileTreePart): IChatTreeData {
		const { value, baseUri } = part;
		function convert(items: ProX-Code.ChatResponseFileTree[], baseUri: URI): extHostProtocol.IChatResponseProgressFileTreeData[] {
	...
	export function to(part: Dto<IChatTreeData>): ProX-Code.ChatResponseFileTreePart {
		const treeData = revive<extHostProtocol.IChatResponseProgressFileTreeData>(part.treeData);
		function convert(items: extHostProtocol.IChatResponseProgressFileTreeData[]): ProX-Code.ChatResponseFileTree[] {
			return items.map(item => {
				return {
					name: item.label,
...
export namespace ChatResponseAnchorPart {
	export function from(part: ProX-Code.ChatResponseAnchorPart): Dto<IChatContentInlineReference> {
		// Work around type-narrowing confusion between ProX-Code.Uri and URI
		const isUri = (thing: unknown): thing is ProX-Code.Uri => URI.isUri(thing);
		const isSymbolInformation = (thing: object): thing is ProX-Code.SymbolInformation => 'name' in thing;
	...
	export function to(part: Dto<IChatContentInlineReference>): ProX-Code.ChatResponseAnchorPart {
		...
		return new types.ChatResponseAnchorPart(
			URI.isUri(value.inlineReference)
				...
				: 'location' in value.inlineReference
					? WorkspaceSymbol.to(value.inlineReference) as ProX-Code.SymbolInformation
...
export namespace ChatResponseProgressPart {
	export function from(part: ProX-Code.ChatResponseProgressPart): Dto<IChatProgressMessage> {
		return {
			kind: 'progressMessage',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatProgressMessage>): ProX-Code.ChatResponseProgressPart {
		return new types.ChatResponseProgressPart(part.content.value);
	}
}

export namespace ChatResponseWarningPart {
	export function from(part: ProX-Code.ChatResponseWarningPart): Dto<IChatWarningMessage> {
		return {
			kind: 'warning',
			content: MarkdownString.from(part.value)
		};
	}
	export function to(part: Dto<IChatWarningMessage>): ProX-Code.ChatResponseWarningPart {
		return new types.ChatResponseWarningPart(part.content.value);
	}
}

export namespace ChatResponseExtensionsPart {
	export function from(part: ProX-Code.ChatResponseExtensionsPart): Dto<IChatExtensionsContent> {
		return {
			kind: 'extensions',
...
export namespace ChatResponseMovePart {
	export function from(part: ProX-Code.ChatResponseMovePart): Dto<IChatMoveMessage> {
		return {
			kind: 'move',
			uri: part.uri,
	...
	export function to(part: Dto<IChatMoveMessage>): ProX-Code.ChatResponseMovePart {
...
export namespace ChatPrepareToolInvocationPart {
	export function from(part: ProX-Code.ChatPrepareToolInvocationPart): IChatPrepareToolInvocationPart {
		return {
	...
	export function to(part: IChatPrepareToolInvocationPart): ProX-Code.ChatPrepareToolInvocationPart {
		return new types.ChatPrepareToolInvocationPart(part.toolName);
	}
}

export namespace ChatTask {
	export function from(part: ProX-Code.ChatResponseProgressPart2): IChatTaskDto {
		return {
			kind: 'progressTask',
			content: MarkdownString.from(part.value),
		};
...
export namespace ChatResponseCommandButtonPart {
	export function from(part: ProX-Code.ChatResponseCommandButtonPart, commandsConverter: CommandsConverter, commandDisposables: DisposableStore): Dto<IChatCommandButton> {
	...
	export function to(part: Dto<IChatCommandButton>, commandsConverter: CommandsConverter): ProX-Code.ChatResponseCommandButtonPart {
		// If the command isn't in the converter, then this session may have been restored, and the command args don't exist anymore
...
export namespace ChatResponseTextEditPart {
	export function from(part: ProX-Code.ChatResponseTextEditPart): Dto<IChatTextEdit> {
		return {
			kind: 'textEdit',
			uri: part.uri,
	...
	export function to(part: Dto<IChatTextEdit>): ProX-Code.ChatResponseTextEditPart {
...
export namespace NotebookEdit {
	export function from(edit: ProX-Code.NotebookEdit): extHostProtocol.ICellEditOperationDto {
...
export namespace ChatResponseNotebookEditPart {
	export function from(part: ProX-Code.ChatResponseNotebookEditPart): extHostProtocol.IChatNotebookEditDto {
		return {
			kind: 'notebookEdit',
			uri: part.uri,
	...
	export function from(part: types.ChatResponseReferencePart): Dto<IChatContentReference> {
			...
			return {
				...
				reference: {
					...
					value: URI.isUri(part.value.value) || !part.value.value ?
						part.value.value :
						Location.from(part.value.value as ProX-Code.Location)
				},
				iconPath,
		...
		return {
			...
			reference: URI.isUri(part.value) || typeof part.value === 'string' ?
				part.value :
				Location.from(<ProX-Code.Location>part.value),
			iconPath,
			options: part.options
		};
	}
	export function to(part: Dto<IChatContentReference>): ProX-Code.ChatResponseReferencePart {
		const value = revive<IChatContentReference>(part);

		const mapValue = (value: URI | languages.Location): ProX-Code.Uri | ProX-Code.Location => URI.isUri(value) ?
			value :
			Location.to(value);
		...
		) as ProX-Code.ChatResponseReferencePart; // 'value' is extended with variableName
	}
}

export namespace ChatResponseCodeCitationPart {
	export function from(part: ProX-Code.ChatResponseCodeCitationPart): Dto<IChatCodeCitation> {
		return {
			kind: 'codeCitation',
			value: part.value,
...
export namespace ChatResponsePart {
	...
	export function from(part: ProX-Code.ExtendedChatResponsePart, commandsConverter: CommandsConverter, commandDisposables: DisposableStore): extHostProtocol.IChatProgressDto {
	...
	export function to(part: extHostProtocol.IChatProgressDto, commandsConverter: CommandsConverter): ProX-Code.ChatResponsePart | undefined {
		switch (part.kind) {
	...
	export function toContent(part: extHostProtocol.IChatContentProgressDto, commandsConverter: CommandsConverter): ProX-Code.ChatResponseMarkdownPart | ProX-Code.ChatResponseFileTreePart | ProX-Code.ChatResponseAnchorPart | ProX-Code.ChatResponseCommandButtonPart | undefined {
		switch (part.kind) {
...
export namespace ChatAgentRequest {
	export function to(request: IChatAgentRequest, location2: ProX-Code.ChatRequestEditorData | ProX-Code.ChatRequestNotebookData | undefined, model: ProX-Code.LanguageModelChat, diagnostics: readonly [ProX-Code.Uri, readonly ProX-Code.Diagnostic[]][], toolSelection: ProX-Code.ChatRequestToolSelection | undefined, tools: Map<string, boolean>, extension: IRelaxedExtensionDescription, logService: ILogService): ProX-Code.ChatRequest {
		...
		const requestWithAllProps: ProX-Code.ChatRequest = {
...
export namespace ChatRequestDraft {
	export function to(request: IChatRequestDraft): ProX-Code.ChatRequestDraft {
		return {
...
export namespace ChatPromptReference {
	export function to(variable: IChatRequestVariableEntry, diagnostics: readonly [ProX-Code.Uri, readonly ProX-Code.Diagnostic[]][], logService: ILogService): ProX-Code.ChatPromptReference | undefined {
		let value: ProX-Code.ChatPromptReference['value'] = variable.value;
		if (!value) {
			let varStr: string;
			try {
		...
		if (isUriComponents(value)) {
			...
			value = new types.ChatReferenceDiagnostic(diagnostics.map(([uri, d]): [ProX-Code.Uri, ProX-Code.Diagnostic[]] => {
...
export namespace ChatLanguageModelToolReference {
	export function to(variable: IChatRequestVariableEntry): ProX-Code.ChatLanguageModelToolReference {
...
export namespace ChatAgentCompletionItem {
	export function from(item: ProX-Code.ChatCompletionItem, commandsConverter: CommandsConverter, disposables: DisposableStore): extHostProtocol.IChatAgentCompletionItem {
		return {
			id: item.id,
			label: item.label,
...
export namespace ChatAgentResult {
	export function to(result: IChatAgentResult): ProX-Code.ChatResult {
		return {
	...
	export function from(result: ProX-Code.ChatResult): Dto<IChatAgentResult> {
		return {
			errorDetails: result.errorDetails,
...
export namespace ChatAgentUserActionEvent {
	export function to(result: IChatAgentResult, event: IChatUserActionEvent, commandsConverter: CommandsConverter): ProX-Code.ChatUserActionEvent | undefined {
		...
		if (event.action.kind === 'command') {
			...
			const commandAction: ProX-Code.ChatCommandAction = { kind: 'command', commandButton };
			return { action: commandAction, result: ehResult };
		} else if (event.action.kind === 'followUp') {
			const followupAction: ProX-Code.ChatFollowupAction = { kind: 'followUp', followup: ChatFollowup.to(event.action.followup) };
...
export namespace TerminalQuickFix {
	export function from(quickFix: ProX-Code.TerminalQuickFixTerminalCommand | ProX-Code.TerminalQuickFixOpener | ProX-Code.Command, converter: Command.ICommandsConverter, disposables: DisposableStore): extHostProtocol.ITerminalQuickFixTerminalCommandDto | extHostProtocol.ITerminalQuickFixOpenerDto | extHostProtocol.ICommandDto | undefined {
...
export namespace TerminalCompletionItemDto {
	export function from(item: ProX-Code.TerminalCompletionItem): extHostProtocol.ITerminalCompletionItemDto {
		return {
			...item,
...
export namespace TerminalCompletionList {
	export function from(completions: ProX-Code.TerminalCompletionList | ProX-Code.TerminalCompletionItem[]): extHostProtocol.TerminalCompletionListDto {
...
export namespace TerminalResourceRequestConfig {
	export function from(resourceRequestConfig: ProX-Code.TerminalResourceRequestConfig): extHostProtocol.TerminalResourceRequestConfigDto {
		return {
...
export namespace InlineCompletionEndOfLifeReason {
	export function to<T>(reason: languages.InlineCompletionEndOfLifeReason<T>, convertFn: (item: T) => ProX-Code.InlineCompletionItem | undefined): ProX-Code.InlineCompletionEndOfLifeReason {
...
export namespace DebugTreeItem {
	export function from(item: ProX-Code.DebugTreeItem, id: number): IDebugVisualizationTreeItem {
		return {
			id,
			label: item.label,
			description: item.description,
...
export namespace LanguageModelToolDescription {
	export function to(item: IToolData): ProX-Code.LanguageModelToolInformation {
		return {
...
export namespace LanguageModelToolResult {
	export function to(result: IToolResult): ProX-Code.LanguageModelToolResult {
	...
	export function from(result: ProX-Code.ExtendedLanguageModelToolResult, extension: IExtensionDescription): Dto<IToolResult> {
		...
		return {
			...
			toolResultDetails: result.toolResultDetails?.map(detail => URI.isUri(detail) ? detail : Location.from(detail as ProX-Code.Location)),
		};
	}
}

export namespace LanguageModelToolResult2 {
	export function to(result: IToolResult): ProX-Code.LanguageModelToolResult2 {
	...
	export function from(result: ProX-Code.ExtendedLanguageModelToolResult, extension: IExtensionDescription): Dto<IToolResult> | SerializableObjectWithBuffers<Dto<IToolResult>> {
		if (result.toolResultMessage) {
			checkProposedApiEnabled(extension, 'chatParticipantPrivate');
		}
...
export namespace IconPath {
	export function fromThemeIcon(iconPath: ProX-Code.ThemeIcon): languages.IconPath {
		return iconPath;
	}
}

export namespace AiSettingsSearch {
	export function fromSettingsSearchResult(result: ProX-Code.SettingsSearchResult): AiSettingsSearchResult {
		return {
			query: result.query,
...
export namespace McpServerDefinition {
	function isHttpConfig(candidate: ProX-Code.McpServerDefinition): candidate is ProX-Code.McpHttpServerDefinition {
		return !!(candidate as ProX-Code.McpHttpServerDefinition).uri;
	}

	export function from(item: ProX-Code.McpServerDefinition): McpServerLaunch.Serialized {
