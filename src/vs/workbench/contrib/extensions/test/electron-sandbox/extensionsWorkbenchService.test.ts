...
suite('ExtensionsWorkbenchServiceTest', () => {
	...
	test('test for installed extensions', async () => {
		...
		assert.ok(actual.iconUrl === 'file:///localPath1/localIcon1' || actual.iconUrl === 'ProX-Code-file://ProX-Code-app/localPath1/localIcon1');
		assert.ok(actual.iconUrlFallback === 'file:///localPath1/localIcon1' || actual.iconUrlFallback === 'ProX-Code-file://ProX-Code-app/localPath1/localIcon1');
