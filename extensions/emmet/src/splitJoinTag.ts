...
function getRangesToReplace(document: ProX-Code.TextDocument, nodeToUpdate: HtmlFlatNode): ProX-Code.TextEdit {
	let rangeToReplace: ProX-Code.Range;
	...
	return new ProX-Code.TextEdit(rangeToReplace, textToReplaceWith);
}
