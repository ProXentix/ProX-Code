...
class AudioPreviewProvider implements ProX-Code.CustomReadonlyEditorProvider {

	public static readonly viewType = 'ProX-Code.audioPreview';
...
<body class="container loading" data-ProX-Code-context='{ "preventDefaultContextMenuItems": true }'>
	<div class="loading-indicator"></div>
	<div class="loading-error">
		<p>${ProX-Code.l10n.t("An error occurred while loading the audio file.")}</p>
...
export function registerAudioPreviewSupport(context: ProX-Code.ExtensionContext, binarySizeStatusBarEntry: BinarySizeStatusBarEntry): ProX-Code.Disposable {
	const provider = new AudioPreviewProvider(context.extensionUri, binarySizeStatusBarEntry);
	return ProX-Code.window.registerCustomEditorProvider(AudioPreviewProvider.viewType, provider, {
