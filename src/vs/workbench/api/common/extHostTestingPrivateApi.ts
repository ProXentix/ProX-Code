...
export interface IExtHostTestItemApi {
	controllerId: string;
	parent?: ProX-Code.TestItem;
	listener?: (evt: ExtHostTestItemEvent) => void;
}

const eventPrivateApis = new WeakMap<ProX-Code.TestItem, IExtHostTestItemApi>();

export const createPrivateApiFor = (impl: ProX-Code.TestItem, controllerId: string) => {
 ...
 */
export const getPrivateApiFor = (impl: ProX-Code.TestItem) => {
