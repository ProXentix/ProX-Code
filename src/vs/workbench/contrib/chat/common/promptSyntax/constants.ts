 ...
 */
export const PROMPT_DOCUMENTATION_URL = 'https://aka.ms/ProX-Code-ghcp-prompt-snippets';
export const INSTRUCTIONS_DOCUMENTATION_URL = 'https://aka.ms/ProX-Code-ghcp-custom-instructions';
