...
import { ExtensionContext, extensions, l10n } from 'ProX-Code';
import { BaseLanguageClient, LanguageClient, LanguageClientOptions, ServerOptions, TransportKind } from 'ProX-Code-languageclient/node';
...
export async function activate(context: ExtensionContext) {
	const clientMain = extensions.getExtension('ProX-Code.css-language-features')?.packageJSON?.main || '';
