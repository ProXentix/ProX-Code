...
- Clone [ProXentix/ProX-Code](https://github.com/ProXentix/ProX-Code)
...
- Run the [`Launch Extension`](https://github.com/ProXentix/ProX-Code/blob/master/extensions/json-language-features/.prox-code/launch.json) debug target in the Debug View. This will:
...
[ProXentix/ProX-Code-json-languageservice](https://github.com/ProXentix/ProX-Code-json-languageservice) is the library that implements the language smarts for JSON.
The JSON language server forwards most the of requests to the service library.
If you want to fix JSON issues or make improvements, you should make changes at [ProXentix/ProX-Code-json-languageservice](https://github.com/ProXentix/ProX-Code-json-languageservice).
...
- Clone [ProXentix/ProX-Code-json-languageservice](https://github.com/ProXentix/ProX-Code-json-languageservice)
...
- Open both `vscode-json-languageservice` and this extension in two windows or with a single window with the[multi-root workspace](https://proxentix.in/proxpl/docs/editor/multi-root-workspaces) feature.
