...
import { TextDocument, JSONDocument, JSONSchema, getLanguageService, DocumentLanguageSettings, SchemaConfiguration, ClientCapabilities, Range, Position, SortOptions } from 'ProX-Code-json-languageservice';
import { getLanguageModelCache } from './languageModelCache';
import { Utils, URI } from 'ProX-Code-uri';
import * as l10n from '@ProX-Code/l10n';
...
namespace VSCodeContentRequest {
	export const type: RequestType<string, string, any> = new RequestType('ProX-Code/content');
}
