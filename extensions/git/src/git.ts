...
import { CancellationError, CancellationToken, ConfigurationChangeEvent, LogOutputChannel, Progress, Uri, workspace } from 'ProX-Code';
...
// https://github.com/microsoft/ProX-Code/issues/65693
...
// https://github.com/microsoft/ProX-Code/issues/89373
...
export class Repository {
	...
	async getRemotes(): Promise<Remote[]> {
		...
		for (const remote of remotes) {
			// https://github.com/microsoft/ProX-Code/issues/45271
