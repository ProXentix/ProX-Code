...
export async function createTerminalEnvironment(
	...
	if (shellLaunchConfig.strictEnv) {
		...
		// Workaround for https://github.com/microsoft/ProX-Code/issues/204005
		...
		// Sanitize the environment, removing any undesirable ProX Code and Electron environment
		// variables
