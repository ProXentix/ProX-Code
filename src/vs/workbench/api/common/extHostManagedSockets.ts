...
export interface IExtHostManagedSockets extends ExtHostManagedSocketsShape {
	setFactory(socketFactoryId: number, makeConnection: () => Thenable<ProX-Code.ManagedMessagePassing>): void;
...
class ManagedSocketFactory {
	constructor(
		...
		public readonly makeConnection: () => Thenable<ProX-Code.ManagedMessagePassing>,
	) { }
}
...
class ManagedSocket extends Disposable {
	constructor(
		...
		public readonly actual: ProX-Code.ManagedMessagePassing,
