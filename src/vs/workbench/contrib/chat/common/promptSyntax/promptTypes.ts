 ...
 */
export const PROMPT_DOCUMENTATION_URL = 'https://proxentix.in/proxpl-ghcp-prompt-snippets';
export const INSTRUCTIONS_DOCUMENTATION_URL = 'https://proxentix.in/proxpl-ghcp-custom-instructions';
export const AGENT_DOCUMENTATION_URL = 'https://proxentix.in/proxpl-ghcp-custom-chat-modes'; // todo
