...
class ExtHostWebviewView extends Disposable implements ProX-Code.WebviewView {
	...
	#badge: ProX-Code.ViewBadge | undefined;
	...
	public get webview(): ProX-Code.Webview { return this.#webview; }
	...
	public get badge(): ProX-Code.ViewBadge | undefined {
		this.assertNotDisposed();
		return this.#badge;
	}

	public set badge(badge: ProX-Code.ViewBadge | undefined) {
		this.assertNotDisposed();
...
export class ExtHostWebviewViews implements extHostProtocol.ExtHostWebviewViewsShape {
	...
	private readonly _viewProviders = new Map<string, {
		readonly provider: ProX-Code.WebviewViewProvider;
	...
	public registerWebviewViewProvider(
		...
		viewType: string,
		provider: ProX-Code.WebviewViewProvider,
		webviewOptions?: {
