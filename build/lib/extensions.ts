...
function fromLocalWebpack(extensionPath: string, webpackConfigFileName: string, disableMangle: boolean): Stream {
	const vsce = require('@ProX-Code/vsce') as typeof import('@ProX-Code/vsce');
...
const excludedExtensions = [
	'ProX-Code-api-tests',
	'ProX-Code-colorize-tests',
	'ProX-Code-colorize-perf-tests',
	'ProX-Code-test-resolver',
	'ms-ProX-Code.node-debug',
	'ms-ProX-Code.node-debug2',
];
