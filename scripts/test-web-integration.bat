...
call node .\test\integration\browser\out\index.js --workspacePath=.\extensions\ProX-Code-api-tests\testWorkspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=.\extensions\ProX-Code-api-tests --extensionTestsPath=.\extensions\ProX-Code-api-tests\out\singlefolder-tests %*
if %errorlevel% neq 0 exit /b %errorlevel%

echo.
echo ### API tests (workspace)
call node .\test\integration\browser\out\index.js --workspacePath=.\extensions\ProX-Code-api-tests\testworkspace.code-workspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=.\extensions\ProX-Code-api-tests --extensionTestsPath=.\extensions\ProX-Code-api-tests\out\workspace-tests %*
if %errorlevel% neq 0 exit /b %errorlevel%
