...
export class TextEditorDecorationType {
	...
	readonly value: ProX-Code.TextEditorDecorationType;

	constructor(proxy: MainThreadTextEditorsShape, extension: IExtensionDescription, options: ProX-Code.DecorationRenderOptions) {
...
class TextEditorEdit {
	...
	private readonly _document: ProX-Code.TextDocument;
	...
	constructor(document: ProX-Code.TextDocument, options: { undoStopBefore: boolean; undoStopAfter: boolean }) {
...
export class ExtHostTextEditorOptions {
	...
	readonly value: ProX-Code.TextEditorOptions;
	...
	public assign(newOptions: ProX-Code.TextEditorOptions) {
...
export class ExtHostTextEditor {
	...
	private _diffInformation: ProX-Code.TextEditorDiffInformation[] | undefined;

	readonly value: ProX-Code.TextEditor;

	constructor(
		readonly id: string,
		private readonly _proxy: MainThreadTextEditorsShape,
		private readonly _logService: ILogService,
		document: Lazy<ProX-Code.TextDocument>,
		selections: Selection[], options: IResolvedTextEditorConfiguration,
		visibleRanges: Range[], viewColumn: ProX-Code.ViewColumn | undefined
	) {
		...
		this.value = Object.freeze({
			...
			// --- options
			get options(): ProX-Code.TextEditorOptions {
				return that._options.value;
			},
			set options(value: ProX-Code.TextEditorOptions) {
				if (!that._disposed) {
					that._options.assign(value);
				}
			},
			// --- view column
			get viewColumn(): ProX-Code.ViewColumn | undefined {
			...
			setDecorations(decorationType: ProX-Code.TextEditorDecorationType, ranges: Range[] | ProX-Code.DecorationOptions[]): void {
			...
			revealRange(range: Range, revealType: ProX-Code.TextEditorRevealType): void {
			...
			show(column: ProX-Code.ViewColumn) {
	...
	_acceptViewColumn(value: ProX-Code.ViewColumn) {
		ok(!this._disposed);
	...
	_acceptDiffInformation(diffInformation: ProX-Code.TextEditorDiffInformation[] | undefined): void {
		ok(!this._disposed);
		this._diffInformation = diffInformation;
	}

	private async _trySetSelection(): Promise<ProX-Code.TextEditor | null | undefined> {
