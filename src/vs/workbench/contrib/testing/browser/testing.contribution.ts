...
CommandsRegistry.registerCommand({
	id: 'ProX-Code.testing.getControllersWithTests',
...
CommandsRegistry.registerCommand({
	id: 'ProX-Code.testing.getTestsInFile',
