...
export function nextItemStylesheet(document: ProX-Code.TextDocument, startPosition: ProX-Code.Position, endPosition: ProX-Code.Position, rootNode: Node): ProX-Code.Selection | undefined {
...
export function prevItemStylesheet(document: ProX-Code.TextDocument, startPosition: ProX-Code.Position, endPosition: ProX-Code.Position, rootNode: CssNode): ProX-Code.Selection | undefined {
	const startOffset = document.offsetAt(startPosition);
	const endOffset = document.offsetAt(endPosition);
...
function getSelectionFromNode(document: ProX-Code.TextDocument, node: Node | undefined): ProX-Code.Selection | undefined {
	if (!node) {
		return;
	}
...
function getSelectionFromProperty(document: ProX-Code.TextDocument, node: Node | undefined, selectionStart: number, selectionEnd: number, selectFullValue: boolean, direction: string): ProX-Code.Selection | undefined {
	...
	return new ProX-Code.Selection(newSelectionStart, newSelectionEnd);
}
