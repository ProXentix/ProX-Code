 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in ProX Code UI).
 */
 ...
 * to represent terminals that appear in other parts of the ProX Code UI outside
 ...
 * positions, decorations, etc.) from the rest of ProX-Code. This is the interface to use for
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their ProX Code OSC `SetMarker`
