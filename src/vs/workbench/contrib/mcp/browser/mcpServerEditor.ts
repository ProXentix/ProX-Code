			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--ProX-Code-button-secondaryBackground);
						border-color: var(--ProX-Code-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--ProX-Code-button-secondaryHoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--ProX-Code-button-secondaryForeground);
						/* Chevron up icon */
