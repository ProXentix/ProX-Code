...
import type * as Parser from '@ProX-Code/tree-sitter-wasm';
...
export class TreeSitterImporter implements ITreeSitterImporter {
	readonly _serviceBrand: undefined;
	private _treeSitterImport: typeof import('@ProX-Code/tree-sitter-wasm') | undefined;

	constructor() { }

	private async _getTreeSitterImport() {
		if (!this._treeSitterImport) {
			this._treeSitterImport = await importAMDNodeModule<typeof import('@ProX-Code/tree-sitter-wasm')>('@ProX-Code/tree-sitter-wasm', 'wasm/tree-sitter.js');
		}
