...
export class ExtHostUrls implements ExtHostUrlsShape {
	...
	private handlers = new Map<number, ProX-Code.UriHandler>();
	...
	registerUriHandler(extension: IExtensionDescription, handler: ProX-Code.UriHandler): ProX-Code.Disposable {
	...
	async createAppUri(uri: URI): Promise<ProX-Code.Uri> {
