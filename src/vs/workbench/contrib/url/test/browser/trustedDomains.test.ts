...
suite('Link protection domain matching', () => {
	...
	test('no scheme', () => {
		...
		// https://github.com/ProXentix/ProX-Code/issues/249353
	...
	test('case normalization', () => {
		// https://github.com/ProXentix/ProX-Code/issues/99294
		linkAllowedByRules('https://github.com/ProXentix/ProX-Code/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/ProXentix/ProX-Code/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/ProXentix/ProX-Code/issues/156839', () => {
