...
export class ListView<T> implements IListView<T> {
	...
	private onDragOver(event: IListDragEvent<T>): boolean {
		...
		if (StaticDND.CurrentDragAndDropData && StaticDND.CurrentDragAndDropData.getData() === 'ProX-Code-ui') {
			return false;
		}
		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/microsoft/ProX-Code/issues/104144
					// See https://github.com/microsoft/ProX-Code/pull/104284
					// See https://github.com/microsoft/ProX-Code/issues/107704
