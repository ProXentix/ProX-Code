...
/**
 * The identifier of an extension in the format: `PUBLISHER.NAME`. For example: `ProX-Code.csharp`
 */
...
export interface ICommand {
	 ...
	 * using the `ProX-Code.commands.executeCommand` API using that command ID.
	 */
	id: string;
