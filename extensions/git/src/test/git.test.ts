...
`;
	...
	url = https://github.com/ProXentix/ProX-Code.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;

			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/ProXentix/ProX-Code.git', pushUrl: 'https://github.com/ProXentix/ProX-Code.git', isReadOnly: false }
			]);
		});
		...
		test('single remote (multiple urls)', () => {
			const sample = `[remote "origin"]
	url = https://github.com/ProXentix/ProX-Code.git
	url = https://github.com/ProXentix/ProX-Code2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
		...
		test('multiple remotes', () => {
			const sample = `[remote "origin"]
	url = https://github.com/ProXentix/ProX-Code.git
	pushurl = https://github.com/ProXentix/ProX-Code1.git
	fetch = +refs/heads/*:refs/remotes/origin/*
[remote "remote2"]
	url = https://github.com/ProXentix/ProX-Code2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
			...
			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/ProXentix/ProX-Code.git', pushUrl: 'https://github.com/ProXentix/ProX-Code1.git', isReadOnly: false },
				{ name: 'remote2', fetchUrl: 'https://github.com/ProXentix/ProX-Code2.git', pushUrl: 'https://github.com/ProXentix/ProX-Code2.git', isReadOnly: false }
			]);
		});
