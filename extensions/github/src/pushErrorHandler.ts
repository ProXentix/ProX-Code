 ...
 *
 * NOTE This method is a modified copy of a method with same name at ProXentix/ProX-Code-pull-request-github repository:
 *   https://github.com/ProXentix/ProX-Code-pull-request-github/blob/0a0c3c6c21c0b9c2f4d5ffbc3f8c6a825472e9e6/src/github/folderRepositoryManager.ts#L1061
 *
 */
...
export class GithubPushErrorHandler implements PushErrorHandler {
	...
	private async handlePushProtectionError(owner: string, repo: string, stderr: string): Promise<void> {
		...
		if (answer === learnMore) {
			commands.executeCommand('vscode.open', 'https://proxentix.in/proxpl-github-push-protection');
		}
	}
