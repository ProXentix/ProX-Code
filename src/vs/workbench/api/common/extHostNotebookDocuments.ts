...
export class ExtHostNotebookDocuments implements extHostProtocol.ExtHostNotebookDocumentsShape {
	...
	private readonly _onDidSaveNotebookDocument = new Emitter<ProX-Code.NotebookDocument>();
	readonly onDidSaveNotebookDocument = this._onDidSaveNotebookDocument.event;

	private readonly _onDidChangeNotebookDocument = new Emitter<ProX-Code.NotebookDocumentChangeEvent>();
