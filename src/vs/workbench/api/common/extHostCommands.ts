			...
			},
			{
				processArgument(arg) {
					return cloneAndChange(arg, function (obj) {
						// Reverse of https://github.com/microsoft/ProX-Code/blob/1f28c5fc681f4c01226460b6d1c7e91b8acb4a5b/src/vs/workbench/api/node/extHostCommands.ts#L112-L127
...
export class CommandsConverter implements extHostTypeConverter.Command.ICommandsConverter {
	...
	private readonly _cache = new Map<string, ProX-Code.Command>();
	...
	toInternal(command: ProX-Code.Command, disposables: DisposableStore): ICommandDto;
	toInternal(command: ProX-Code.Command | undefined, disposables: DisposableStore): ICommandDto | undefined;
	toInternal(command: ProX-Code.Command | undefined, disposables: DisposableStore): ICommandDto | undefined {
	...
	fromInternal(command: ICommandDto): ProX-Code.Command | undefined {
	...
	getActualCommand(...args: any[]): ProX-Code.Command | undefined {
...
export class ApiCommandArgument<V, O = V> {
	...
	static readonly TestItem = new ApiCommandArgument('testItem', 'A ProX Code TestItem', v => v instanceof TestItemImpl, extHostTypeConverter.TestItem.from);
	static readonly TestProfile = new ApiCommandArgument('testProfile', 'A ProX Code test profile', v => v instanceof extHostTypes.TestRunProfileBase, extHostTypeConverter.TestRunProfile.from);
