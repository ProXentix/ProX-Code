...
const { defineConfig } = require('@ProX-Code/test-cli');

/**
 * A list of extension folders who have opted into tests, or configuration objects.
 * Edit me to add more!
 *
 * @type {Array<Partial<import("@ProX-Code/test-cli").TestConfiguration> & { label: string }>}
 */
const extensions = [
	{
	...
	{
		label: 'ProX-Code-colorize-tests',
		workspaceFolder: `extensions/ProX-Code-colorize-tests/test`,
		mocha: { timeout: 60_000 }
	},
	{
	...
	{
		label: 'ProX-Code-colorize-perf-tests',
		workspaceFolder: `extensions/ProX-Code-colorize-perf-tests/test`,
	...
	{
		label: 'ProX-Code-api-tests-folder',
		extensionDevelopmentPath: `extensions/ProX-Code-api-tests`,
		workspaceFolder: `extensions/ProX-Code-api-tests/testWorkspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/ProX-Code-api-tests/out/singlefolder-tests/**/*.test.js',
	},
	{
		label: 'ProX-Code-api-tests-workspace',
		extensionDevelopmentPath: `extensions/ProX-Code-api-tests`,
		workspaceFolder: `extensions/ProX-Code-api-tests/testworkspace.code-workspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/ProX-Code-api-tests/out/workspace-tests/**/*.test.js',
	}
];
...
const config = defineConfig(extensions.map(extension => {
	/** @type {import('@ProX-Code/test-cli').TestConfiguration} */
	const config = {
		platform: 'desktop',
