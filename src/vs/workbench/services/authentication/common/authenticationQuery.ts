...
/**
 * Query interface for type-agnostic operations on all entities (extensions) within a specific account
 */
export interface IAccountEntitiesQuery extends IBaseQuery {
	readonly accountName: string;

	/**
	 * Check if this account has been used by any entity (extension)
	...
	/**
	 * Remove access to this account for all entities (extensions)
	 */
...
export interface IProviderQuery extends IBaseQuery {
	...
	/**
	 * Get information about active entities (extensions) within this provider
