...
export class ExtHostStatusBarEntry implements ProX-Code.StatusBarItem {
	...
	private _tooltip?: string | ProX-Code.MarkdownString;
	private _tooltip2?: string | ProX-Code.MarkdownString | undefined | ((token: ProX-Code.CancellationToken) => Promise<string | ProX-Code.MarkdownString | undefined>);
	...
	private _command?: {
		readonly fromApi: string | ProX-Code.Command;
		readonly internal: ICommandDto;
	};

	private _timeoutHandle: any;
	private _accessibilityInformation?: ProX-Code.AccessibilityInformation;
	...
	private validatePriority(priority?: number): number | undefined {
		...
		// https://github.com/microsoft/ProX-Code/issues/133317
	...
	public get alignment(): ProX-Code.StatusBarAlignment {
	...
	public get tooltip(): ProX-Code.MarkdownString | string | undefined {
		return this._tooltip;
	}

	public get tooltip2(): ProX-Code.MarkdownString | string | undefined | ((token: ProX-Code.CancellationToken) => Promise<ProX-Code.MarkdownString | string | undefined>) {
		if (this._extension) {
	...
	public get command(): string | ProX-Code.Command | undefined {
		return this._command?.fromApi;
	}

	public get accessibilityInformation(): ProX-Code.AccessibilityInformation | undefined {
	...
	public set tooltip(tooltip: ProX-Code.MarkdownString | string | undefined) {
		this._tooltip = tooltip;
		this.update();
	}

	public set tooltip2(tooltip: ProX-Code.MarkdownString | string | undefined | ((token: ProX-Code.CancellationToken) => Promise<ProX-Code.MarkdownString | string | undefined>)) {
		if (this._extension) {
			checkProposedApiEnabled(this._extension, 'statusBarItemTooltip');
		}
	...
	public set command(command: string | ProX-Code.Command | undefined) {
	...
	public set accessibilityInformation(accessibilityInformation: ProX-Code.AccessibilityInformation | undefined) {
...
export class ExtHostStatusBar implements ExtHostStatusBarShape {
	...
	async $provideTooltip(entryId: string, cancellation: ProX-Code.CancellationToken): Promise<string | htmlContent.IMarkdownString | undefined> {
	...
	createStatusBarEntry(extension: IExtensionDescription | undefined, id: string, alignment?: ExtHostStatusBarAlignment, priority?: number): ProX-Code.StatusBarItem;
	createStatusBarEntry(extension: IExtensionDescription, id?: string, alignment?: ExtHostStatusBarAlignment, priority?: number): ProX-Code.StatusBarItem;
	createStatusBarEntry(extension: IExtensionDescription, id: string, alignment?: ExtHostStatusBarAlignment, priority?: number): ProX-Code.StatusBarItem {
