...
export class ExtHostChatStatus {
	...
	private readonly _items = new Map<string, ProX-Code.ChatStatusItem>();
	...
	createChatStatusItem(extension: IExtensionDescription, id: string): ProX-Code.ChatStatusItem {
		...
		const item = Object.freeze<ProX-Code.ChatStatusItem>({
			id: id,
