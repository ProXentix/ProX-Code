...
import { FileRename, RequestType } from 'ProX-Code-languageclient';
import type * as lsp from 'ProX-Code-languageserver-types';
import type * as md from 'ProX-Code-markdown-languageservice';


export type ResolvedDocumentLinkTarget =
	| { readonly kind: 'file'; readonly uri: ProX-Code.Uri; position?: lsp.Position; fragment?: string }
	| { readonly kind: 'folder'; readonly uri: ProX-Code.Uri }
	| { readonly kind: 'external'; readonly uri: ProX-Code.Uri };
