...
export class ExtHostSpeech implements ExtHostSpeechShape {
	...
	private readonly providers = new Map<number, ProX-Code.SpeechProvider>();
	private readonly sessions = new Map<number, CancellationTokenSource>();
	private readonly synthesizers = new Map<number, ProX-Code.TextToSpeechSession>();
	...
	registerProvider(extension: ExtensionIdentifier, identifier: string, provider: ProX-Code.SpeechProvider): IDisposable {
