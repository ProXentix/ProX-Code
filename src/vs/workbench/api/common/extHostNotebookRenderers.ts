...
export class ExtHostNotebookRenderers implements ExtHostNotebookRenderersShape {
	private readonly _rendererMessageEmitters = new Map<string /* rendererId */, Emitter<{ editor: ProX-Code.NotebookEditor; message: any }>>();
	...
	public createRendererMessaging(manifest: IExtensionDescription, rendererId: string): ProX-Code.NotebookRendererMessaging {
		...
		const messaging: ProX-Code.NotebookRendererMessaging = {
