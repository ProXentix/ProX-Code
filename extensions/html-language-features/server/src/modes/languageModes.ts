...
import { getCSSLanguageService } from 'ProX-Code-css-languageservice';
import {
	DocumentContext, getLanguageService as getHTMLLanguageService, IHTMLDataProvider, ClientCapabilities
} from 'ProX-Code-html-languageservice';
import {
	SelectionRange,
	...
	WorkspaceFolder
} from 'ProX-Code-languageserver';
import { DocumentUri, TextDocument } from 'ProX-Code-languageserver-textdocument';
...
export { ClientCapabilities, DocumentContext, LanguageService, HTMLDocument, HTMLFormatConfiguration, TokenType } from 'ProX-Code-html-languageservice';

export { TextDocument, DocumentUri } from 'ProX-Code-languageserver-textdocument';
