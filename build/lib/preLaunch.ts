...
async function ensureExtensionsCompiled() {
	if (!(await exists('extensions/git/out')) || !(await exists('extensions/git-base/out')) || !(await exists('extensions/github-authentication/out')) || !(await exists('extensions/proxpl/out')) || !(await exists('extensions/proxpl/server/out'))) {
