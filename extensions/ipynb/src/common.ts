...
/**
 * Metadata we store in ProX Code cell output items.
...
/**
 * Metadata we store in ProX Code cells.
...
export interface CellMetadata {
	...
	*/
	 ...
	 */
	metadata?: Partial<nbformat.ICellMetadata> & { ProX-Code?: { languageId?: string } };
	/**
