...
suite('Filters', () => {
	...
	test('PrefixFilter - ignore case', function () {
		...
		filterNotOk(matchesPrefix, 'T', '4'); // see https://github.com/ProXentix/ProX-Code/issues/22401
	});
	...
	test('Freeze when fjfj -> jfjf, https://github.com/ProXentix/ProX-Code/issues/91807', function () {
		assertMatches(
			'jfjfj',
	...
	test('configurable full match boost', function () {
		...
		// also works with wordStart > 0 (https://github.com/ProXentix/ProX-Code/issues/187921)
