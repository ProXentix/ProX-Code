...
function generateApiProposalNames() {
    ...
    const pattern = /ProX-Code\.proposed\.([a-zA-Z\d]+)\.d\.ts$/;
    ...
    const output = input
        ...
        proposals.set(proposalName, {
            proposal: `https://raw.githubusercontent.com/microsoft/ProX-Code/main/src/ProX-Code-dts/ProX-Code.proposed.${proposalName}.d.ts`,
...
exports.compileApiProposalNamesTask = task.define('compile-api-proposal-names', () => {
    return gulp_1.default.src('src/ProX-Code-dts/**')
        .pipe(generateApiProposalNames())
        .pipe(gulp_1.default.dest('src'))
        .pipe(apiProposalNamesReporter.end(true));
});
exports.watchApiProposalNamesTask = task.define('watch-api-proposal-names', () => {
    const task = () => gulp_1.default.src('src/ProX-Code-dts/**')
        .pipe(generateApiProposalNames())
        .pipe(apiProposalNamesReporter.end(true));
    return watch('src/ProX-Code-dts/**', { readDelay: 200 })
