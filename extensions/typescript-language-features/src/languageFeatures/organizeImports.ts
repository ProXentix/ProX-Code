...
const organizeImportsCommand: OrganizeImportsCommandMetadata = {
	...
	title: ProX-Code.l10n.t("Organize Imports"),
	kind: ProX-Code.CodeActionKind.SourceOrganizeImports,
...
const sortImportsCommand: OrganizeImportsCommandMetadata = {
	...
	minVersion: API.v430,
	title: ProX-Code.l10n.t("Sort Imports"),
	kind: ProX-Code.CodeActionKind.Source.append('sortImports'),
...
const removeUnusedImportsCommand: OrganizeImportsCommandMetadata = {
	...
	minVersion: API.v490,
	title: ProX-Code.l10n.t("Remove Unused Imports"),
	kind: ProX-Code.CodeActionKind.Source.append('removeUnusedImports'),
...
class ImportCodeAction extends ProX-Code.CodeAction {
	constructor(
		title: string,
...
class ImportsCodeActionProvider implements ProX-Code.CodeActionProvider<ImportCodeAction> {
	...
	async resolveCodeAction(codeAction: ImportCodeAction, token: ProX-Code.CancellationToken): Promise<ImportCodeAction | undefined> {
		...
		disposables.push(
			conditionalRegistration([
				...
				return ProX-Code.Disposable.from(
					ProX-Code.languages.registerCodeActionsProvider(selector.semantic, provider, {
			...
			...command.commandIds.map(id =>
				commandManager.register({
					id,
					execute() {
						return ProX-Code.commands.executeCommand('editor.action.sourceAction', {
