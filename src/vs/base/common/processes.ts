...
/**
 * Sanitizes a ProX Code process environment by removing all Electron/ProX Code-related values.
 */
...
export function removeDangerousEnvVariables(env: IProcessEnvironment | undefined): void {
	...
	// See https://github.com/microsoft/ProX-Code/issues/130072
	delete env['DEBUG'];

	if (isLinux) {
		// Unset `LD_PRELOAD`, as it might lead to process crashes
		// See https://github.com/microsoft/ProX-Code/issues/134177
