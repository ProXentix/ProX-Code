...
function getKnownVariableNames() {
    if (!knownVariables) {
        const knownVariablesFileContent = (0, fs_1.readFileSync)(path_1.default.join(__dirname, './ProX-Code-known-variables.json'), 'utf8').toString();
...
const iconVariable = /^--ProX-Code-icon-.+-(content|font-family)$/;
