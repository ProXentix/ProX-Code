...
suite('ExtHostCommands', function () {
	...
	test('onCommand:abc activates extensions when executed from command palette, but not when executed programmatically with ProX-Code.commands.executeCommand #150293', async function () {
