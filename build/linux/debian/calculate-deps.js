...
function generatePackageDeps(files, arch, chromiumSysroot, ProX-CodeSysroot) {
    const dependencies = files.map(file => calculatePackageDeps(file, arch, chromiumSysroot, ProX-CodeSysroot));
...
function calculatePackageDeps(binaryPath, arch, chromiumSysroot, ProX-CodeSysroot) {
    try {
    ...
    switch (arch) {
        case 'amd64':
            cmd.push(`-l${chromiumSysroot}/usr/lib/x86_64-linux-gnu`, `-l${chromiumSysroot}/lib/x86_64-linux-gnu`, `-l${ProX-CodeSysroot}/usr/lib/x86_64-linux-gnu`, `-l${ProX-CodeSysroot}/lib/x86_64-linux-gnu`);
            break;
        case 'armhf':
            cmd.push(`-l${chromiumSysroot}/usr/lib/arm-linux-gnueabihf`, `-l${chromiumSysroot}/lib/arm-linux-gnueabihf`, `-l${ProX-CodeSysroot}/usr/lib/arm-linux-gnueabihf`, `-l${ProX-CodeSysroot}/lib/arm-linux-gnueabihf`);
            break;
        case 'arm64':
            cmd.push(`-l${chromiumSysroot}/usr/lib/aarch64-linux-gnu`, `-l${chromiumSysroot}/lib/aarch64-linux-gnu`, `-l${ProX-CodeSysroot}/usr/lib/aarch64-linux-gnu`, `-l${ProX-CodeSysroot}/lib/aarch64-linux-gnu`);
            break;
    }
    cmd.push(`-l${chromiumSysroot}/usr/lib`);
    cmd.push(`-L${ProX-CodeSysroot}/debian/libxkbfile1/DEBIAN/shlibs`);
    ...
    // Refs https://github.com/microsoft/ProX-Code/issues/188881.
