		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/ProXentix/ProX-Code/issues/104144
					// See https://github.com/ProXentix/ProX-Code/pull/104284
					// See https://github.com/ProXentix/ProX-Code/issues/107704
