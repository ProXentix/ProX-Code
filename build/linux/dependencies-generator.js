...
async function getDependencies(packageType, buildDir, applicationName, arch) {
    ...
    if (packageType === 'deb') {
        ...
        const ProX-CodeSysroot = await (0, install_sysroot_1.getVSCodeSysroot)(arch);
        dependencies = (0, calculate_deps_1.generatePackageDeps)(files, arch, chromiumSysroot, ProX-CodeSysroot);
    }
    else {
