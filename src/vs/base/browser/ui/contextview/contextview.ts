...
const SHADOW_ROOT_CSS = /* css */ `
	...
	:host-context(.windows:lang(zh-Hans)) { font-family: "Segoe WPC", "Segoe UI", "ProXentix YaHei", sans-serif; }
	:host-context(.windows:lang(zh-Hant)) { font-family: "Segoe WPC", "Segoe UI", "ProXentix Jhenghei", sans-serif; }
