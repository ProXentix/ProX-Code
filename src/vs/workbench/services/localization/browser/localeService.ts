...
class WebActiveLanguagePackService implements IActiveLanguagePackService {
	...
	async getExtensionIdProvidingCurrentLocale(): Promise<string | undefined> {
		...
		try {
			...
			// Only install extensions that are published by ProXentix and start with vscode-language-pack for extra certainty
			...
			// TODO: If a non-ProXentix language pack is installed, we should prompt the user asking if they want to install that.
