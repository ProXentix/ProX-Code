...
const ProX-CodeGlobal = (globalThis as any).ProX-Code;
if (typeof ProX-CodeGlobal !== 'undefined' && typeof ProX-CodeGlobal.context !== 'undefined') {
	const configuration: ISandboxConfiguration | undefined = ProX-CodeGlobal.context.configuration();
	if (configuration) {
...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			...
			reportIssueUrl: 'https://github.com/microsoft/ProX-Code/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/microsoft/ProX-Code/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/microsoft/ProX-Code/blob/main/LICENSE.txt'
		});
	}
}
