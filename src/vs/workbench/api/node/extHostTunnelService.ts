...
function knownExcludeCmdline(command: string): boolean {
	...
	return !!command.match(/.*\.ProX-Code-server-[a-zA-Z]+\/bin.*/)
...
export class NodeExtHostTunnelService extends ExtHostTunnelService {
	...
	protected override makeManagedTunnelFactory(authority: ProX-Code.ManagedResolvedAuthority): ProX-Code.RemoteAuthorityResolver['tunnelFactory'] {
...
class ExtHostManagedSocket extends ManagedSocket {
	public static connect(
		passing: ProX-Code.ManagedMessagePassing,
	...
	constructor(
		private readonly passing: ProX-Code.ManagedMessagePassing,
		debugLabel: string,
