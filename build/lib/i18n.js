...
const iconv_lite_umd_1 = __importDefault(require("@ProX-Code/iconv-lite-umd"));
const l10n_dev_1 = require("@ProX-Code/l10n-dev");
...
function processCoreBundleFormat(base, fileHeader, languages, json, emitter) {
    ...
    sortedLanguages.forEach((language) => {
        ...
        const i18nFile = path_1.default.join(languageDirectory, `ProX-Code-language-pack-${languageFolderName}`, 'translations', 'main.i18n.json');
        let allMessages;
...
const editorProject = 'ProX-Code-editor', workbenchProject = 'ProX-Code-workbench', extensionsProject = 'ProX-Code-extensions', setupProject = 'ProX-Code-setup', serverProject = 'ProX-Code-server';
