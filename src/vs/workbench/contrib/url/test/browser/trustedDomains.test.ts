...
suite('Link protection domain matching', () => {
	...
	test('case normalization', () => {
		// https://github.com/microsoft/ProX-Code/issues/99294
		linkAllowedByRules('https://github.com/microsoft/ProX-Code/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/microsoft/ProX-Code/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/microsoft/ProX-Code/issues/156839', () => {
