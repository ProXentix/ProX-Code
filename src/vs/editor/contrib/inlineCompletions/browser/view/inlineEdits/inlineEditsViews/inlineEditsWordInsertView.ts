				...
				return [
					n.div({
						style: {
							...
							borderRadius: '4px',
							background: 'var(--ProX-Code-editor-background)'
						}
					}, []),
					n.div({
						style: {
							...
							padding: '0px',
							textAlign: 'center',
							background: 'var(--ProX-Code-inlineEdit-modifiedChangedTextBackground)',
					...
					n.div({
						style: {
							...
							background: 'var(--ProX-Code-inlineEdit-wordReplacementView-background)',
						}
					}, []),
					n.svg({
						viewBox: '0 0 12 18',
						...
						n.svgElem('path', {
							...
							fill: 'var(--ProX-Code-inlineEdit-modifiedChangedTextBackground)',
						})
					])
				];
			})
