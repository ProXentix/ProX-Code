...
suite('TerminalLinkParsing', () => {
	...
	suite('detectLinks', () => {
		...
		test('should detect both suffix and non-suffix links on a single line', () => {
			deepStrictEqual(
				detectLinks('PS C:\\Github\\microsoft\\ProX-Code> echo \'"foo", line 5, col 6\'', OperatingSystem.Windows),
				[
					{
						path: {
							index: 3,
							text: 'C:\\Github\\microsoft\\ProX-Code'
						},
						prefix: undefined,
						suffix: undefined
					},
		...
		suite('"|"', () => {
			test('should exclude pipe characters from link paths', () => {
				deepStrictEqual(
					detectLinks('|C:\\Github\\microsoft\\ProX-Code|', OperatingSystem.Windows),
					[
						{
							path: {
								index: 1,
			...
			test('should exclude pipe characters from link paths with suffixes', () => {
				deepStrictEqual(
					detectLinks('|C:\\Github\\microsoft\\ProX-Code:400|', OperatingSystem.Windows),
					[
						{
							path: {
								index: 1,
