...
suite('Decoration Render Options', () => {
	...
	const options: IDecorationRenderOptions = {
		gutterIconPath: URI.parse('https://github.com/microsoft/ProX-Code/blob/main/resources/linux/code.png'),
	...
	test('css properties', () => {
		...
		assert(sheet.indexOf(`{background:url('${CSS.escape('https://github.com/microsoft/ProX-Code/blob/main/resources/linux/code.png')}') center center no-repeat;background-size:contain;}`) >= 0);
	...
	test('css properties, gutterIconPaths', () => {
		...
		if (platform.isWindows) {
			...
			assertBackground(CSS.escape('file:///c:/files/miles/more.png'), CSS.escape('ProX-Code-file://ProX-Code-app/c:/files/miles/more.png'));
			s.removeDecorationType('example');

			// single quote must always be escaped/encoded
			s.registerDecorationType('test', 'example', { gutterIconPath: URI.file('c:\\files\\foo\\b\'ar.png') });
			assertBackground(CSS.escape('file:///c:/files/foo/b\'ar.png'), CSS.escape('ProX-Code-file://ProX-Code-app/c:/files/foo/b\'ar.png'));
			s.removeDecorationType('example');
		} else {
			// unix file path (used as string)
			s.registerDecorationType('test', 'example', { gutterIconPath: URI.file('/Users/foo/bar.png') });
			assertBackground(CSS.escape('file:///Users/foo/bar.png'), CSS.escape('ProX-Code-file://ProX-Code-app/Users/foo/bar.png'));
			s.removeDecorationType('example');

			// single quote must always be escaped/encoded
			s.registerDecorationType('test', 'example', { gutterIconPath: URI.file('/Users/foo/b\'ar.png') });
			assertBackground(CSS.escape('file:///Users/foo/b\'ar.png'), CSS.escape('ProX-Code-file://ProX-Code-app/Users/foo/b\'ar.png'));
			s.removeDecorationType('example');
		}
