...
export default tseslint.config(
	...
	// ProX-Code tests specific rules
	{
		files: [
			'src/vs/**/*.test.ts'
		],
	...
	// ProX-Code API
	{
		...
		rules: {
			...
			'local/ProX-Code-dts-create-func': 'warn',
			'local/ProX-Code-dts-literal-or-types': 'warn',
			'local/ProX-Code-dts-string-type-literals': 'warn',
			'local/ProX-Code-dts-interface-naming': 'warn',
			'local/ProX-Code-dts-cancellation': 'warn',
			'local/ProX-Code-dts-use-export': 'warn',
			'local/ProX-Code-dts-use-thenable': 'warn',
			'local/ProX-Code-dts-ProX-Code-in-comments': 'warn',
			'local/ProX-Code-dts-provider-naming': [
				'warn',
				{
					'allowed': [
						'FileSystemProvider',
			...
			'local/ProX-Code-dts-event-naming': [
				'warn',
				{
					'allowed': [
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'allow': [
						'@parcel/watcher',
						'@ProX-Code/sqlite3',
						'@ProX-Code/ProX-Code-languagedetection',
						'@ProX-Code/ripgrep',
						'@ProX-Code/iconv-lite-umd',
						'@ProX-Code/policy-watcher',
						'@ProX-Code/proxy-agent',
						'@ProX-Code/spdlog',
						'@ProX-Code/windows-process-tree',
						'assert',
						'child_process',
						'console',
						'cookie',
				...
				},
				{
					...
					'restrictions': [
						...
						'vs/platform/*/~',
						'vs/editor/~',
						'@ProX-Code/tree-sitter-wasm' // node module allowed even in /common/
					]
				},
				{
				...
				},
				{
					...
					'restrictions': [
						...
						'@ProX-Code/tree-sitter-wasm' // type import
					]
				},
				{
				...
				},
				{
					...
					'restrictions': [
						...
						'tas-client-umd', // node module allowed even in /common/
						'ProX-Code-textmate', // node module allowed even in /common/
						'@ProX-Code/ProX-Code-languagedetection', // node module allowed even in /common/
						'@ProX-Code/tree-sitter-wasm', // type import
						{
							'when': 'hasBrowser',
							'pattern': '@xterm/xterm'
				...
				},
				{
					...
					'restrictions': [
						...
						'ProX-Code-notebook-renderer', // Type only import
						'@ProX-Code/tree-sitter-wasm', // type import
						{
							'when': 'hasBrowser',
							'pattern': '@xterm/xterm'
