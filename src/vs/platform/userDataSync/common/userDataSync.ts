...
export function registerConfiguration(): IDisposable {
	const ignoredSettingsSchemaId = 'ProX-Code://schemas/ignoredSettings';
	...
	configurationRegistry.registerConfiguration({
		...
		properties: {
			...
			'settingsSync.ignoredExtensions': {
				'type': 'array',
				markdownDescription: localize('settingsSync.ignoredExtensions', "List of extensions to be ignored while synchronizing. The identifier of an extension is always `${publisher}.${name}`. For example: `ProX-Code.csharp`."),
				items: [{
					type: 'string',
...
export const USER_DATA_SYNC_SCHEME = 'ProX-Code-userdata-sync';
