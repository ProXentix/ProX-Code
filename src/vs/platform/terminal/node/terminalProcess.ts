...
const enum ShutdownConstants {
	 ...
	 * [2]: https://github.com/microsoft/ProX-Code/issues/71966
...
const enum Constants {
	 ...
	 * hang issue. See:
	 * - https://github.com/microsoft/ProX-Code/issues/71966
	 * - https://github.com/microsoft/ProX-Code/issues/117956
	 * - https://github.com/microsoft/ProX-Code/issues/121336
	 */
...
export class TerminalProcess extends Disposable implements ITerminalChildProcess {
	...
	private _sendProcessTitle(ptyProcess: IPty): void {
		...
		// HACK: The node-pty API can return undefined somehow https://github.com/microsoft/ProX-Code/issues/222323
	...
	shutdown(immediate: boolean): void {
		...
		// mitigation for https://github.com/microsoft/ProX-Code/issues/71966 which causes the pty host
	...
	async getCwd(): Promise<string> {
		if (isMacintosh) {
			...
			// this is fixed in ProX Code's internal Electron.
			// https://github.com/Microsoft/ProX-Code/issues/105446
