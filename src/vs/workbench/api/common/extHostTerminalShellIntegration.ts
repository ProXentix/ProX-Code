...
export interface IExtHostTerminalShellIntegration extends ExtHostTerminalShellIntegrationShape {
	...
	readonly onDidChangeTerminalShellIntegration: Event<ProX-Code.TerminalShellIntegrationChangeEvent>;
	readonly onDidStartTerminalShellExecution: Event<ProX-Code.TerminalShellExecutionStartEvent>;
	readonly onDidEndTerminalShellExecution: Event<ProX-Code.TerminalShellExecutionEndEvent>;
}
...
export class ExtHostTerminalShellIntegration extends Disposable implements IExtHostTerminalShellIntegration {
	...
	protected readonly _onDidChangeTerminalShellIntegration = new Emitter<ProX-Code.TerminalShellIntegrationChangeEvent>();
	readonly onDidChangeTerminalShellIntegration = this._onDidChangeTerminalShellIntegration.event;
	protected readonly _onDidStartTerminalShellExecution = new Emitter<ProX-Code.TerminalShellExecutionStartEvent>();
	readonly onDidStartTerminalShellExecution = this._onDidStartTerminalShellExecution.event;
	protected readonly _onDidEndTerminalShellExecution = new Emitter<ProX-Code.TerminalShellExecutionEndEvent>();
	...
	public $shellExecutionStart(instanceId: number, commandLineValue: string, commandLineConfidence: TerminalShellExecutionCommandLineConfidence, isTrusted: boolean, cwd: UriComponents | undefined): void {
		...
		const commandLine: ProX-Code.TerminalShellExecutionCommandLine = {
...
export class InternalTerminalShellIntegration extends Disposable {
	...
	private _env: ProX-Code.TerminalShellIntegrationEnvironment | undefined;
	private _cwd: URI | undefined;

	readonly store: DisposableStore = this._register(new DisposableStore());

	readonly value: ProX-Code.TerminalShellIntegration;

	protected readonly _onDidRequestChangeShellIntegration = this._register(new Emitter<ProX-Code.TerminalShellIntegrationChangeEvent>());
	...
	protected readonly _onDidRequestEndExecution = this._register(new Emitter<ProX-Code.TerminalShellExecutionEndEvent>());
	...
	constructor(
		private readonly _terminal: ProX-Code.Terminal,
		private readonly _onDidStartTerminalShellExecution: Emitter<ProX-Code.TerminalShellExecutionStartEvent>
	) {
		super();
		...
		this.value = {
			...
			get env(): ProX-Code.TerminalShellIntegrationEnvironment | undefined {
				if (!that._env) {
					return undefined;
				}
			...
			// executeCommand(commandLine: string): ProX-Code.TerminalShellExecution;
			// executeCommand(executable: string, args: string[]): ProX-Code.TerminalShellExecution;
			executeCommand(commandLineOrExecutable: string, args?: string[]): ProX-Code.TerminalShellExecution {
	...
	requestNewShellExecution(commandLine: ProX-Code.TerminalShellExecutionCommandLine, cwd: URI | undefined) {
	...
	startShellExecution(commandLine: ProX-Code.TerminalShellExecutionCommandLine, cwd: URI | undefined): undefined {
	...
	endShellExecution(commandLine: ProX-Code.TerminalShellExecutionCommandLine | undefined, exitCode: number | undefined): void {
...
class InternalTerminalShellExecution {
	readonly value: ProX-Code.TerminalShellExecution;

	private _dataStream: ShellExecutionDataStream | undefined;
	private _isEnded: boolean = false;

	constructor(
		private _commandLine: ProX-Code.TerminalShellExecutionCommandLine,
		readonly cwd: URI | undefined,
	) {
		const that = this;
		this.value = {
			get commandLine(): ProX-Code.TerminalShellExecutionCommandLine {
	...
	endExecution(commandLine: ProX-Code.TerminalShellExecutionCommandLine | undefined): void {
		if (commandLine) {
 ...
 * execution.
 */
function isSubExecution(unresolvedCommandLines: string[], commandLine: ProX-Code.TerminalShellExecutionCommandLine): { unresolvedCommandLines: string[] } | false {
