...
import { Event, EventEmitter, ExtensionContext, SecretStorage, SecretStorageChangeEvent } from 'ProX-Code';
...
export class BetterTokenStorage<T> {
	...
	// The ProX-Code SecretStorage instance for this extension.
	 ...
	 * @param context the ProX-Code Context used to register disposables and retreive the ProX-Code.SecretStorage for this instance of ProX Code
	 */
	...
	// a different window of ProX Code and sends the necessary event if it has.
	...
	private async handleSecretChange(e: SecretStorageChangeEvent) {
		...
		// The KeyList is only a list of keys to aid initial start up of ProX Code to know which
