...
export const ipcRenderer: IpcRenderer = ProX-CodeGlobal.ipcRenderer;
export const ipcMessagePort: IpcMessagePort = ProX-CodeGlobal.ipcMessagePort;
export const webFrame: WebFrame = ProX-CodeGlobal.webFrame;
export const process: ISandboxNodeProcess = ProX-CodeGlobal.process;
export const context: ISandboxContext = ProX-CodeGlobal.context;
export const webUtils: WebUtils = ProX-CodeGlobal.webUtils;
