...
export class VersionStatus extends Disposable {
	...
	private readonly _statusItem: ProX-Code.LanguageStatusItem;
	...
	constructor(
		...
		this._statusItem = this._register(ProX-Code.languages.createLanguageStatusItem('typescript.version', jsTsLanguageModes));

		this._statusItem.name = ProX-Code.l10n.t("TypeScript Version");
		this._statusItem.detail = ProX-Code.l10n.t("TypeScript version");
	...
	private onDidChangeTypeScriptVersion(version: TypeScriptVersion) {
		...
		this._statusItem.command = {
			...
			title: ProX-Code.l10n.t("Select Version"),
