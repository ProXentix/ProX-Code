...
class SimpleBrowserOverlayWidget {
	...
	constructor(
		...
		this.imagesFolder = joinPath(this.environmentService.workspaceStorageHome, 'ProX-Code-chat-images');
		...
		this._store.add(autorun(r => {
			...
			for (const group of groups) {
				...
				if (!(group instanceof EditorGroupView)) {
					// TODO@jrieken better with https://github.com/microsoft/ProX-Code/tree/ben/layout-group-container
					continue;
				}
