...
export class CodeLensContribution implements IEditorContribution {
	...
	private _updateLensStyle(): void {
		...
		style.setProperty('--ProX-Code-editorCodeLens-lineHeight', `${codeLensHeight}px`);
		style.setProperty('--ProX-Code-editorCodeLens-fontSize', `${fontSize}px`);
		style.setProperty('--ProX-Code-editorCodeLens-fontFeatureSettings', editorFontInfo.fontFeatureSettings);

		if (fontFamily) {
			style.setProperty('--ProX-Code-editorCodeLens-fontFamily', fontFamily);
			style.setProperty('--ProX-Code-editorCodeLens-fontFamilyDefault', EDITOR_FONT_DEFAULTS.fontFamily);
		}
