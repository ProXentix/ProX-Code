...
echo
node test/integration/browser/out/index.js --workspacePath $ROOT/extensions/ProX-Code-api-tests/testWorkspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=$ROOT/extensions/ProX-Code-api-tests --extensionTestsPath=$ROOT/extensions/ProX-Code-api-tests/out/singlefolder-tests "$@"

echo
echo "### API tests (workspace)"
echo
node test/integration/browser/out/index.js --workspacePath $ROOT/extensions/ProX-Code-api-tests/testworkspace.code-workspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=$ROOT/extensions/ProX-Code-api-tests --extensionTestsPath=$ROOT/extensions/ProX-Code-api-tests/out/workspace-tests "$@"
