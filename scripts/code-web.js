...
async function ensureWebDevExtensions(verbose) {
	...
	// Playground (https://github.com/ProXentix/ProX-Code-web-playground)
	...
	if (downloadPlayground) {
		...
		const playgroundRepo = `https://raw.githubusercontent.com/ProXentix/ProX-Code-web-playground/main/`;
