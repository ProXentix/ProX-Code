...
export class DynamicEditorConfigurations extends Disposable implements IWorkbenchContribution {
	...
	private static readonly AUTO_LOCK_REMOVE_EDITORS = new Set<string>([
		...
		'ProX-Code-interactive-input',
		'interactive',
		'ProX-Code.markdown.preview.editor'
	]);
		...
		this.editorAssociationsConfigurationNode = {
			...
			properties: {
				'workbench.editorAssociations': {
					type: 'object',
					markdownDescription: localize('editor.editorAssociations', "Configure [glob patterns](https://aka.ms/ProX-Code-glob-patterns) to editors (for example `\"*.hex\": \"hexEditor.hexedit\"`). These have precedence over the default behavior."),
					patternProperties: {
						'.*': {
							type: 'string',
							enum: binaryEditorCandidates,
