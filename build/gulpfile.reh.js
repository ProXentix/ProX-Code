...
const { ProX-CodeWebResourceIncludes, createVSCodeWebFileContentMapper } = require('./gulpfile.ProX-Code.web');
...
['reh', 'reh-web'].forEach(type => {
	const bundleTask = task.define(`bundle-ProX-Code-${type}`, task.series(
	...
	const minifyTask = task.define(`minify-ProX-Code-${type}`, task.series(
		...
		optimize.minifyTask(`out-ProX-Code-${type}`, `https://main.ProX-Code-cdn.net/sourcemaps/${commit}/core`)
	));
