...
echo
"$INTEGRATION_TEST_ELECTRON_PATH" $ROOT/extensions/ProX-Code-api-tests/testWorkspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=$ROOT/extensions/ProX-Code-api-tests --extensionTestsPath=$ROOT/extensions/ProX-Code-api-tests/out/singlefolder-tests $API_TESTS_EXTRA_ARGS
kill_app

echo
echo "### API tests (workspace)"
echo
"$INTEGRATION_TEST_ELECTRON_PATH" $ROOT/extensions/ProX-Code-api-tests/testworkspace.code-workspace --enable-proposed-api=ProX-Code.ProX-Code-api-tests --extensionDevelopmentPath=$ROOT/extensions/ProX-Code-api-tests --extensionTestsPath=$ROOT/extensions/ProX-Code-api-tests/out/workspace-tests $API_TESTS_EXTRA_ARGS
kill_app

echo
echo "### Colorize tests"
echo
npm run test-extension -- -l ProX-Code-colorize-tests
kill_app

echo
echo "### Terminal Suggest tests"
echo
npm run test-extension -- -l terminal-suggest --enable-proposed-api=ProX-Code.ProX-Code-api-tests
kill_app
