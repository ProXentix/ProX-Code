...
Use this prompt when migrating issues from one GitHub repository to another (e.g., from `ProXentix/ProX-Code-copilot` to `ProXentix/ProX-Code`).
...
```
https://github.com/ProXentix/ProX-Code-copilot/issues?q=is%3Aissue+is%3Aopen+assignee%3Ayoyokrazy
```
...
```
repo:ProXentix/ProX-Code-copilot is:issue is:open assignee:yoyokrazy
```
...
```
https://github.com/ProXentix/ProX-Code-copilot/issues/12345
```
...
✅ Correct: `https://github.com/ProXentix/ProX-Code-copilot/issues/12345`
✅ Also OK: `ProXentix/ProX-Code-copilot#12345`
...
### Original Issue Body (in `ProXentix/ProX-Code-copilot`):

```markdown
I noticed @johndoe had a similar issue in #9999. cc @janedoe for visibility.

Related to #8888 and ProXentix/ProX-Code#12345.
...
### Migrated Issue Body (in `ProXentix/ProX-Code`):

```markdown
_Transferred from ProXentix/ProX-Code-copilot#12345_
_Original author: `@originalauthor`_

---

I noticed `@johndoe` had a similar issue in https://github.com/ProXentix/ProX-Code-copilot/issues/9999. cc `@janedoe` for visibility.

Related to https://github.com/ProXentix/ProX-Code-copilot/issues/8888 and ProXentix/ProX-Code#12345.
...
Note: The `ProXentix/ProX-Code#12345` reference was already a cross-repo link, so it stays unchanged.
