...
const regexpModuleLocation: AppResourcePath = `${nodeModulesPath}/ProX-Code-regexp-languagedetection`;
const regexpModuleLocationAsar: AppResourcePath = `${nodeModulesAsarPath}/ProX-Code-regexp-languagedetection`;
const moduleLocation: AppResourcePath = `${nodeModulesPath}/@ProX-Code/ProX-Code-languagedetection`;
const moduleLocationAsar: AppResourcePath = `${nodeModulesAsarPath}/@ProX-Code/ProX-Code-languagedetection`;
...
export class LanguageDetectionService extends Disposable implements ILanguageDetectionService {
	...
	constructor(
		...
		this._languageDetectionWorkerClient = this._register(new LanguageDetectionWorkerClient(
			...
			languageService,
			telemetryService,
			// TODO See if it's possible to bundle ProX-Code-languagedetection
			useAsar
