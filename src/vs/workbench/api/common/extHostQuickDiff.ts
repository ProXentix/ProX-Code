...
export class ExtHostQuickDiff implements ExtHostQuickDiffShape {
	...
	private providers: Map<number, ProX-Code.QuickDiffProvider> = new Map();
	...
	registerQuickDiffProvider(extension: IExtensionDescription, selector: ProX-Code.DocumentSelector, quickDiffProvider: ProX-Code.QuickDiffProvider, id: string, label: string, rootUri?: ProX-Code.Uri): ProX-Code.Disposable {
