...
let balanceOutStack: Array<readonly ProX-Code.Selection[]> = [];
let lastBalancedSelections: readonly ProX-Code.Selection[] = [];
...
function balance(out: boolean) {
	...
	let newSelections: readonly ProX-Code.Selection[] = editor.selections.map(selection => {
...
function getRangeToBalanceOut(document: ProX-Code.TextDocument, rootNode: HtmlFlatNode, selection: ProX-Code.Selection): ProX-Code.Selection {
	...
	let innerSelection: ProX-Code.Selection;
	let outerSelection: ProX-Code.Selection;
...
function getRangeToBalanceIn(document: ProX-Code.TextDocument, rootNode: HtmlFlatNode, selection: ProX-Code.Selection): ProX-Code.Selection {
	const offset = document.offsetAt(selection.start);
...
function areSameSelections(a: readonly ProX-Code.Selection[], b: readonly ProX-Code.Selection[]): boolean {
