...
export class ExtHostEditors extends Disposable implements ExtHostEditorsShape {
	...
	private readonly _onDidChangeTextEditorSelection = new Emitter<ProX-Code.TextEditorSelectionChangeEvent>();
	private readonly _onDidChangeTextEditorOptions = new Emitter<ProX-Code.TextEditorOptionsChangeEvent>();
	private readonly _onDidChangeTextEditorVisibleRanges = new Emitter<ProX-Code.TextEditorVisibleRangesChangeEvent>();
	private readonly _onDidChangeTextEditorViewColumn = new Emitter<ProX-Code.TextEditorViewColumnChangeEvent>();
	private readonly _onDidChangeTextEditorDiffInformation = new Emitter<ProX-Code.TextEditorDiffInformationChangeEvent>();
	private readonly _onDidChangeActiveTextEditor = new Emitter<ProX-Code.TextEditor | undefined>();
	private readonly _onDidChangeVisibleTextEditors = new Emitter<readonly ProX-Code.TextEditor[]>();

	readonly onDidChangeTextEditorSelection: Event<ProX-Code.TextEditorSelectionChangeEvent> = this._onDidChangeTextEditorSelection.event;
	readonly onDidChangeTextEditorOptions: Event<ProX-Code.TextEditorOptionsChangeEvent> = this._onDidChangeTextEditorOptions.event;
	readonly onDidChangeTextEditorVisibleRanges: Event<ProX-Code.TextEditorVisibleRangesChangeEvent> = this._onDidChangeTextEditorVisibleRanges.event;
	readonly onDidChangeTextEditorViewColumn: Event<ProX-Code.TextEditorViewColumnChangeEvent> = this._onDidChangeTextEditorViewColumn.event;
	readonly onDidChangeTextEditorDiffInformation: Event<ProX-Code.TextEditorDiffInformationChangeEvent> = this._onDidChangeTextEditorDiffInformation.event;
	readonly onDidChangeActiveTextEditor: Event<ProX-Code.TextEditor | undefined> = this._onDidChangeActiveTextEditor.event;
	readonly onDidChangeVisibleTextEditors: Event<readonly ProX-Code.TextEditor[]> = this._onDidChangeVisibleTextEditors.event;
	...
	getActiveTextEditor(): ProX-Code.TextEditor | undefined {
		return this._extHostDocumentsAndEditors.activeEditor();
	}

	getVisibleTextEditors(): ProX-Code.TextEditor[];
	getVisibleTextEditors(internal: true): ExtHostTextEditor[];
	getVisibleTextEditors(internal?: true): ExtHostTextEditor[] | ProX-Code.TextEditor[] {
	...
	showTextDocument(document: ProX-Code.TextDocument, column: ProX-Code.ViewColumn, preserveFocus: boolean): Promise<ProX-Code.TextEditor>;
	showTextDocument(document: ProX-Code.TextDocument, options: { column: ProX-Code.ViewColumn; preserveFocus: boolean; pinned: boolean }): Promise<ProX-Code.TextEditor>;
	showTextDocument(document: ProX-Code.TextDocument, columnOrOptions: ProX-Code.ViewColumn | ProX-Code.TextDocumentShowOptions | undefined, preserveFocus?: boolean): Promise<ProX-Code.TextEditor>;
	async showTextDocument(document: ProX-Code.TextDocument, columnOrOptions: ProX-Code.ViewColumn | ProX-Code.TextDocumentShowOptions | undefined, preserveFocus?: boolean): Promise<ProX-Code.TextEditor> {
	...
	createTextEditorDecorationType(extension: IExtensionDescription, options: ProX-Code.DecorationRenderOptions): ProX-Code.TextEditorDecorationType {
	...
	$acceptEditorDiffInformation(id: string, diffInformation: ITextEditorDiffInformation[] | undefined): void {
		...
		const result = diffInformation.map(diff => {
			...
			const changes = diff.changes.map(change => {
				...
				let kind: ProX-Code.TextEditorChangeKind;
				...
				return {
					...
					kind
				} satisfies ProX-Code.TextEditorChange;
			});
	...
	getDiffInformation(id: string): Promise<ProX-Code.LineChange[]> {
