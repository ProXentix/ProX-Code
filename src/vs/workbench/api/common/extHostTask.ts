...
export interface IExtHostTask extends ExtHostTaskShape {
	...
	taskExecutions: ProX-Code.TaskExecution[];
	onDidStartTask: Event<ProX-Code.TaskStartEvent>;
	onDidEndTask: Event<ProX-Code.TaskEndEvent>;
	onDidStartTaskProcess: Event<ProX-Code.TaskProcessStartEvent>;
	onDidEndTaskProcess: Event<ProX-Code.TaskProcessEndEvent>;
	onDidStartTaskProblemMatchers: Event<ProX-Code.TaskProblemMatcherStartedEvent>;
	onDidEndTaskProblemMatchers: Event<ProX-Code.TaskProblemMatcherEndedEvent>;

	registerTaskProvider(extension: IExtensionDescription, type: string, provider: ProX-Code.TaskProvider): ProX-Code.Disposable;
	registerTaskSystem(scheme: string, info: tasks.ITaskSystemInfoDTO): void;
	fetchTasks(filter?: ProX-Code.TaskFilter): Promise<ProX-Code.Task[]>;
	executeTask(extension: IExtensionDescription, task: ProX-Code.Task): Promise<ProX-Code.TaskExecution>;
	terminateTask(execution: ProX-Code.TaskExecution): Promise<void>;
}

namespace TaskDefinitionDTO {
	export function from(value: ProX-Code.TaskDefinition): tasks.ITaskDefinitionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.ITaskDefinitionDTO): ProX-Code.TaskDefinition | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace TaskPresentationOptionsDTO {
	export function from(value: ProX-Code.TaskPresentationOptions): tasks.ITaskPresentationOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.ITaskPresentationOptionsDTO): ProX-Code.TaskPresentationOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ProcessExecutionOptionsDTO {
	export function from(value: ProX-Code.ProcessExecutionOptions): tasks.IProcessExecutionOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.IProcessExecutionOptionsDTO): ProX-Code.ProcessExecutionOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ProcessExecutionDTO {
	...
	export function from(value: ProX-Code.ProcessExecution): tasks.IProcessExecutionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
namespace ShellExecutionOptionsDTO {
	export function from(value: ProX-Code.ShellExecutionOptions): tasks.IShellExecutionOptionsDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
	}
	export function to(value: tasks.IShellExecutionOptionsDTO): ProX-Code.ShellExecutionOptions | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		return value;
...
namespace ShellExecutionDTO {
	...
	export function from(value: ProX-Code.ShellExecution): tasks.IShellExecutionDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
export namespace CustomExecutionDTO {
	...
	export function from(value: ProX-Code.CustomExecution): tasks.ICustomExecutionDTO {
		return {
...
namespace TaskGroupDTO {
	export function from(value: ProX-Code.TaskGroup): tasks.ITaskGroupDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
...
export namespace TaskDTO {
	export function fromMany(tasks: ProX-Code.Task[], extension: IExtensionDescription): tasks.ITaskDTO[] {
	...
	export function from(value: ProX-Code.Task, extension: IExtensionDescription): tasks.ITaskDTO | undefined {
		if (value === undefined || value === null) {
			return undefined;
		}
		...
		const result: tasks.ITaskDTO = {
			...
			group: TaskGroupDTO.from(value.group as ProX-Code.TaskGroup),
	...
	export async function to(value: tasks.ITaskDTO | undefined, workspace: IExtHostWorkspaceProvider, providedCustomExeutions: Map<string, types.CustomExecution>): Promise<types.Task | undefined> {
		...
		const definition: ProX-Code.TaskDefinition | undefined = TaskDefinitionDTO.to(value.definition);
		let scope: ProX-Code.TaskScope.Global | ProX-Code.TaskScope.Workspace | ProX-Code.WorkspaceFolder | undefined;
		if (value.source) {
...
namespace TaskFilterDTO {
	export function from(value: ProX-Code.TaskFilter | undefined): tasks.ITaskFilterDTO | undefined {
		return value;
	}

	export function to(value: tasks.ITaskFilterDTO): ProX-Code.TaskFilter | undefined {
		if (!value) {
			return undefined;
		}
...
class TaskExecutionImpl implements ProX-Code.TaskExecution {

	readonly #tasks: ExtHostTaskBase;

	constructor(tasks: ExtHostTaskBase, readonly _id: string, private readonly _task: ProX-Code.Task) {
		this.#tasks = tasks;
	}

	public get task(): ProX-Code.Task {
		return this._task;
	}
...
export interface HandlerData {
	type: string;
	provider: ProX-Code.TaskProvider;
...
export abstract class ExtHostTaskBase implements ExtHostTaskShape, IExtHostTask {
	...
	protected readonly _onDidExecuteTask: Emitter<ProX-Code.TaskStartEvent> = new Emitter<ProX-Code.TaskStartEvent>();
	protected readonly _onDidTerminateTask: Emitter<ProX-Code.TaskEndEvent> = new Emitter<ProX-Code.TaskEndEvent>();

	protected readonly _onDidTaskProcessStarted: Emitter<ProX-Code.TaskProcessStartEvent> = new Emitter<ProX-Code.TaskProcessStartEvent>();
	protected readonly _onDidTaskProcessEnded: Emitter<ProX-Code.TaskProcessEndEvent> = new Emitter<ProX-Code.TaskProcessEndEvent>();
	protected readonly _onDidStartTaskProblemMatchers: Emitter<ProX-Code.TaskProblemMatcherStartedEvent> = new Emitter<ProX-Code.TaskProblemMatcherStartedEvent>();
	protected readonly _onDidEndTaskProblemMatchers: Emitter<ProX-Code.TaskProblemMatcherEndedEvent> = new Emitter<ProX-Code.TaskProblemMatcherEndedEvent>();
	...
	public registerTaskProvider(extension: IExtensionDescription, type: string, provider: ProX-Code.TaskProvider): ProX-Code.Disposable {
		if (!provider) {
	...
	public fetchTasks(filter?: ProX-Code.TaskFilter): Promise<ProX-Code.Task[]> {
	...
	public abstract executeTask(extension: IExtensionDescription, task: ProX-Code.Task): Promise<ProX-Code.TaskExecution>;

	public get taskExecutions(): ProX-Code.TaskExecution[] {
		const result: ProX-Code.TaskExecution[] = [];
		this._taskExecutions.forEach(value => result.push(value));
		return result;
	}

	public terminateTask(execution: ProX-Code.TaskExecution): Promise<void> {
	...
	public get onDidStartTask(): Event<ProX-Code.TaskStartEvent> {
	...
	public get onDidEndTask(): Event<ProX-Code.TaskEndEvent> {
	...
	public async $OnDidEndTask(execution: tasks.ITaskExecutionDTO): Promise<void> {
		if (!this._taskExecutionPromises.has(execution.id)) {
			...
			// See https://github.com/microsoft/ProX-Code/commit/aaf73920aeae171096d205efb2c58804a32b6846
			return;
		}
	...
	public get onDidStartTaskProcess(): Event<ProX-Code.TaskProcessStartEvent> {
	...
	public get onDidEndTaskProcess(): Event<ProX-Code.TaskProcessEndEvent> {
	...
	public get onDidStartTaskProblemMatchers(): Event<ProX-Code.TaskProblemMatcherStartedEvent> {
	...
	public get onDidEndTaskProblemMatchers(): Event<ProX-Code.TaskProblemMatcherEndedEvent> {
	...
	protected abstract provideTasksInternal(validTypes: { [key: string]: boolean }, taskIdPromises: Promise<void>[], handler: HandlerData, value: ProX-Code.Task[] | null | undefined): { tasks: tasks.ITaskDTO[]; extension: IExtensionDescription };
	...
	protected async addCustomExecution(taskDTO: tasks.ITaskDTO, task: ProX-Code.Task, isProvided: boolean): Promise<void> {
	...
	protected async getTaskExecution(execution: tasks.ITaskExecutionDTO | string, task?: ProX-Code.Task): Promise<TaskExecutionImpl> {
	...
	protected checkDeprecation(task: ProX-Code.Task, handler: HandlerData) {
	...
	private customExecutionComplete(execution: tasks.ITaskExecutionDTO): void {
		const extensionCallback2: ProX-Code.CustomExecution | undefined = this._activeCustomExecutions2.get(execution.id);
...
export class WorkerExtHostTask extends ExtHostTaskBase {
	...
	public async executeTask(extension: IExtensionDescription, task: ProX-Code.Task): Promise<ProX-Code.TaskExecution> {
		if (!task.execution) {
	...
	protected provideTasksInternal(validTypes: { [key: string]: boolean }, taskIdPromises: Promise<void>[], handler: HandlerData, value: ProX-Code.Task[] | null | undefined): { tasks: tasks.ITaskDTO[]; extension: IExtensionDescription } {
