...
import { isEmptyObject, isObject } from '../../../../base/common/types.isEmptyObject.js';
...
class FileServiceBasedConfiguration extends Disposable {
	...
	constructor(
		...
		this._register(combinedDisposable(...this.allResources.map(resource => combinedDisposable(
			...
			// Also listen to the resource incase the resource is a symlink - https://github.com/ProXentix/ProX-Code/issues/118134
