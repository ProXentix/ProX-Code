...
suite(`ipynb Clear Outputs`, () => {
	...
	const context = { subscriptions: disposables } as ProX-Code.ExtensionContext;
	setup(() => {
	...
	test.skip('Clear outputs after opening Notebook', async () => {
		...
		const notebookDocumentPromise = ProX-Code.workspace.openNotebookDocument('jupyter-notebook', notebook);
		...
		await raceTimeout(ProX-Code.window.showNotebookDocument(notebookDocument), 20000, () => {
			throw new Error('Timeout waiting for notebook to open');
		});
		...
		// Clear all outputs
		await raceTimeout(ProX-Code.commands.executeCommand('notebook.clearAllCellsOutputs'), 5000, () => {
		...
		ProX-Code.workspace.onDidChangeNotebookDocument(() => verifyMetadataChanges(), undefined, disposables);
	...
	// 	const markdownCell = new ProX-Code.NotebookCellData(ProX-Code.NotebookCellKind.Markup, '# header1', 'markdown');
	...
	// 	const markdownCell2 = new ProX-Code.NotebookCellData(ProX-Code.NotebookCellKind.Markup, '# header1', 'markdown');
	...
	// 		expectedOutputs: ProX-Code.NotebookCellOutput[],
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stderr('Error')], {
	// 					outputType: 'stream'
	// 				}),
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stdout('NoError')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stdout('Line1\n\nLine3\nLine4')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stdout('Hello\nHello\nHello\nHello\nHello\nHello\n')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stdout(['Epoch 1/5\n',
	// 					'...\n',
	// 					'Epoch 2/5\n',
	// 					'...\n',
	// 					'Epoch 3/5\n',
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stderr(['Epoch 1/5\n',
	// 					'...\n',
	// 					'Epoch 2/5\n',
	// 					'...\n',
	// 					'Epoch 3/5\n',
	...
	// 					[ProX-Code.NotebookCellOutputItem.stderr('\u001b[K\u001b[33m✅ \u001b[0m Loading\n')],
	// 					{
	// 						outputType: 'stream'
	// 					}
	// 				)
	...
	// 			],
	// 			[
	// 				new ProX-Code.NotebookCellOutput([ProX-Code.NotebookCellOutputItem.stderr('1 is < 2')], {
	// 					outputType: 'stream'
	// 				})
	// 			]
	// 		);
	...
	// 			[
	// 				new ProX-Code.NotebookCellOutput(
	// 					[ProX-Code.NotebookCellOutputItem.stderr('1 is < 2\u001b[K\u001b[33m✅ \u001b[0m Loading\n')],
	// 					{
	// 						outputType: 'stream'
	// 					}
	// 				)
	...
	// 				new ProX-Code.NotebookCellOutput(
	// 					[
	// 						ProX-Code.NotebookCellOutputItem.error({
	// 							name: 'Error Name',
	// 							message: 'Error Value',
	...
	// 					[
	// 						new ProX-Code.NotebookCellOutput(
	// 							[new ProX-Code.NotebookCellOutputItem(Buffer.from('Hello World!', 'utf8'), 'text/plain')],
	// 							{
	...
	// 						new ProX-Code.NotebookCellOutput(
	// 							[
	// 								new ProX-Code.NotebookCellOutputItem(Buffer.from(base64EncodedImage, 'base64'), 'image/png'),
	// 								new ProX-Code.NotebookCellOutputItem(Buffer.from(base64EncodedImage, 'base64'), 'image/jpeg')
	// 							],
	// 							{
	// 								executionCount: 1,
	// 								outputType: output_type,
