...
import { AST as ReAST, RegExpParser, RegExpVisitor } from 'ProX-Code-regexpp';
import { rgPath } from '@ProX-Code/ripgrep';
...
// If @ProX-Code/ripgrep is in an .asar file, then the binary is unpacked.
...
export class RipgrepParser extends EventEmitter {
	...
	private createTextSearchMatch(data: IRgMatch, uri: URI): TextSearchMatch2 {
		...
		// https://github.com/microsoft/ProX-Code/issues/100569#issuecomment-738496991
