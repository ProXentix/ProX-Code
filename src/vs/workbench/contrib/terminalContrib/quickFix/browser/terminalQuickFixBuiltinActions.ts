...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      https://github.com/microsoft/ProX-Code/pull/new/my_branch
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on microsoft/ProX-Code's default branch (...). To find out more, visit:
		// 5:  remote:      https://github.com/microsoft/ProX-Code/security/dependabot
		// 4:  remote:
		// 3:  To https://github.com/microsoft/ProX-Code
