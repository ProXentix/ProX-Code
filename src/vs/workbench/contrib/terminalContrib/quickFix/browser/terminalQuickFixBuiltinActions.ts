...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      https://github.com/ProXentix/ProX-Code/pull/new/my_branch
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on ProXentix/ProX-Code's default branch (...). To find out more, visit:
		// 5:  remote:      https://github.com/ProXentix/ProX-Code/security/dependabot
		// 4:  remote:
		// 3:  To https://github.com/ProXentix/ProX-Code
