...
`;
	...
	url = https://github.com/microsoft/ProX-Code.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;

			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/microsoft/ProX-Code.git', pushUrl: 'https://github.com/microsoft/ProX-Code.git', isReadOnly: false }
			]);
		});
		...
		test('single remote (multiple urls)', () => {
			const sample = `[remote "origin"]
	url = https://github.com/microsoft/ProX-Code.git
	url = https://github.com/microsoft/ProX-Code2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
		...
		test('multiple remotes', () => {
			const sample = `[remote "origin"]
	url = https://github.com/microsoft/ProX-Code.git
	pushurl = https://github.com/microsoft/ProX-Code1.git
	fetch = +refs/heads/*:refs/remotes/origin/*
[remote "remote2"]
	url = https://github.com/microsoft/ProX-Code2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
			...
			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/microsoft/ProX-Code.git', pushUrl: 'https://github.com/microsoft/ProX-Code1.git', isReadOnly: false },
				{ name: 'remote2', fetchUrl: 'https://github.com/microsoft/ProX-Code2.git', pushUrl: 'https://github.com/microsoft/ProX-Code2.git', isReadOnly: false }
			]);
		});
...
`;
	...
	suite('parseLsTree', function () {
		test('sample', function () {
			const input = `040000 tree 0274a81f8ee9ca3669295dc40f510bd2021d0043       -	.ProX-Code
...
100644 blob 56ec42c9dc6fcf4534788f0fe34b36e09f37d085  261186	what.txt2`;
			...
			assert.deepStrictEqual(output, [
				{ mode: '040000', type: 'tree', object: '0274a81f8ee9ca3669295dc40f510bd2021d0043', size: '-', file: '.ProX-Code' },
	...
	suite('parseLsFiles', function () {
		test('sample', function () {
			const input = `100644 7a73a41bfdf76d6f793007240d80983a52f15f97 0	.ProX-Code/settings.json
...
100644 56ec42c9dc6fcf4534788f0fe34b36e09f37d085 0	what.txt2`;
			...
			assert.deepStrictEqual(output, [
				{ mode: '100644', object: '7a73a41bfdf76d6f793007240d80983a52f15f97', stage: '0', file: '.ProX-Code/settings.json' },
