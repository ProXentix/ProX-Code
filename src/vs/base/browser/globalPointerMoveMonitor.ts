		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/microsoft/ProX-Code/issues/161731
					//
			...
			// See https://github.com/microsoft/ProX-Code/issues/144584
			// See https://github.com/microsoft/ProX-Code/issues/146947
