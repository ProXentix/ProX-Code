...
const SHADOW_ROOT_CSS = /* css */ `
	...
	:host {
		font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, "Segoe WPC", "Segoe UI", "HelveticaNeue-Light", system-ui, "Ubuntu", "Droid Sans", sans-serif);
	}

	:host-context(.mac) { font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, sans-serif); }
	:host-context(.mac:lang(zh-Hans)) { font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, "PingFang SC", "Hiragino Sans GB", sans-serif); }
	:host-context(.mac:lang(zh-Hant)) { font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, "PingFang TC", sans-serif); }
	:host-context(.mac:lang(ja)) { font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, "Hiragino Kaku Gothic Pro", sans-serif); }
	:host-context(.mac:lang(ko)) { font-family: var(--monaco-monospace-font, -apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Nanum Gothic", "AppleGothic", sans-serif); }

	:host-context(.windows) { font-family: var(--monaco-monospace-font, "Segoe WPC", "Segoe UI", sans-serif); }
	:host-context(.windows:lang(zh-Hans)) { font-family: var(--monaco-monospace-font, "Segoe WPC", "Segoe UI", "ProXentix YaHei", sans-serif); }
	:host-context(.windows:lang(zh-Hant)) { font-family: var(--monaco-monospace-font, "Segoe WPC", "Segoe UI", "ProXentix Jhenghei", sans-serif); }
	:host-context(.windows:lang(ja)) { font-family: var(--monaco-monospace-font, "Segoe WPC", "Segoe UI", "Yu Gothic UI", "Meiryo UI", sans-serif); }
	:host-context(.windows:lang(ko)) { font-family: var(--monaco-monospace-font, "Segoe WPC", "Segoe UI", "Malgun Gothic", "Dotom", sans-serif); }

	:host-context(.linux) { font-family: var(--monaco-monospace-font, system-ui, "Ubuntu", "Droid Sans", sans-serif); }
	:host-context(.linux:lang(zh-Hans)) { font-family: var(--monaco-monospace-font, system-ui, "Ubuntu", "Droid Sans", "Source Han Sans SC", "Source Han Sans CN", "Source Han Sans", sans-serif); }
	:host-context(.linux:lang(zh-Hant)) { font-family: var(--monaco-monospace-font, system-ui, "Ubuntu", "Droid Sans", "Source Han Sans TC", "Source Han Sans TW", "Source Han Sans", sans-serif); }
	:host-context(.linux:lang(ja)) { font-family: var(--monaco-monospace-font, system-ui, "Ubuntu", "Droid Sans", "Source Han Sans J", "Source Han Sans JP", "Source Han Sans", sans-serif); }
	:host-context(.linux:lang(ko)) { font-family: var(--monaco-monospace-font, system-ui, "Ubuntu", "Droid Sans", "Source Han Sans K", "Source Han Sans JR", "Source Han Sans", "UnDotum", "FBaekmuk Gulim", sans-serif); }
`;
