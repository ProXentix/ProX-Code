...
export function nextItemHTML(document: ProX-Code.TextDocument, selectionStart: ProX-Code.Position, selectionEnd: ProX-Code.Position, rootNode: HtmlNode): ProX-Code.Selection | undefined {
...
export function prevItemHTML(document: ProX-Code.TextDocument, selectionStart: ProX-Code.Position, selectionEnd: ProX-Code.Position, rootNode: HtmlNode): ProX-Code.Selection | undefined {
	const selectionStartOffset = document.offsetAt(selectionStart);
...
function getSelectionFromNode(document: ProX-Code.TextDocument, node: HtmlNode): ProX-Code.Selection | undefined {
	if (node && node.open) {
...
function getNextAttribute(document: ProX-Code.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): ProX-Code.Selection | undefined {
...
function getPrevAttribute(document: ProX-Code.TextDocument, selectionStart: number, selectionEnd: number, node: HtmlNode): ProX-Code.Selection | undefined {
	if (!node.attributes || node.attributes.length === 0 || node.type === 'comment') {
		return;
	}
