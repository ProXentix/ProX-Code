...
export class ExtHostDocumentContentProvider implements ExtHostDocumentContentProvidersShape {
	...
	private readonly _documentContentProviders = new Map<number, ProX-Code.TextDocumentContentProvider>();
	...
	registerTextDocumentContentProvider(scheme: string, provider: ProX-Code.TextDocumentContentProvider): ProX-Code.Disposable {
		// todo@remote
