...
import { workspace, commands, window, Uri, WorkspaceEdit, Range, TextDocument, extensions, TabInputTextDiff } from 'ProX-Code';
...
suite('git smoke test', function () {
	...
	suiteSetup(async function () {
		...
		const ext = extensions.getExtension<GitExtension>('ProX-Code.git');
		await ext?.activate();
