...
export type ExecConfig = {
	...
	readonly cancelOnResourceChange?: ProX-Code.Uri;
...
export interface ITypeScriptServiceClient {
	 ...
	 */
	toResource(filepath: string): ProX-Code.Uri;

	/**
	 * Tries to ensure that a ProX-Code document is open on the TS server.
	 *
	 * @return The normalized path or `undefined` if the document is not open on the server.
	 */
	toOpenTsFilePath(document: ProX-Code.TextDocument | ProX-Code.Uri, options?: {
	 ...
	 */
	hasCapabilityForResource(resource: ProX-Code.Uri, capability: ClientCapability): boolean;

	getWorkspaceRootForResource(resource: ProX-Code.Uri): ProX-Code.Uri | undefined;

	readonly onTsServerStarted: ProX-Code.Event<{ version: TypeScriptVersion; usedApiVersion: API }>;
	readonly onProjectLanguageServiceStateChanged: ProX-Code.Event<Proto.ProjectLanguageServiceStateEventBody>;
	readonly onDidBeginInstallTypings: ProX-Code.Event<Proto.BeginInstallTypesEventBody>;
	readonly onDidEndInstallTypings: ProX-Code.Event<Proto.EndInstallTypesEventBody>;
	readonly onTypesInstallerInitializationFailed: ProX-Code.Event<Proto.TypesInstallerInitializationFailedEventBody>;

	readonly capabilities: ClientCapabilities;
	readonly onDidChangeCapabilities: ProX-Code.Event<void>;
