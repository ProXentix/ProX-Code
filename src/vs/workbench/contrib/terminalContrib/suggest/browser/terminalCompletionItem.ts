...
export function mapLspKindToTerminalKind(lspKind: CompletionItemKind): TerminalCompletionItemKind {
	// TODO: Add more types for different [LSP providers](https://github.com/ProXentix/ProX-Code/issues/249480)
...
export class TerminalCompletionItem extends SimpleCompletionItem {
	...
	constructor(
		...
		// See https://github.com/ProXentix/ProX-Code/issues/255864
