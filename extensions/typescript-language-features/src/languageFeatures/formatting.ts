...
class TypeScriptFormattingProvider implements ProX-Code.DocumentRangeFormattingEditProvider, ProX-Code.OnTypeFormattingEditProvider {
	public constructor(
	...
	public async provideDocumentRangeFormattingEdits(
		...
		options: ProX-Code.FormattingOptions,
		token: ProX-Code.CancellationToken
	): Promise<ProX-Code.TextEdit[] | undefined> {
	...
	public async provideOnTypeFormattingEdits(
		...
		const result: ProX-Code.TextEdit[] = [];
...
export function register(
	...
	return conditionalRegistration([
		...
		return ProX-Code.Disposable.from(
			ProX-Code.languages.registerOnTypeFormattingEditProvider(selector.syntax, formattingProvider, ';', '}', '\n'),
			ProX-Code.languages.registerDocumentRangeFormattingEditProvider(selector.syntax, formattingProvider),
		);
	});
}
