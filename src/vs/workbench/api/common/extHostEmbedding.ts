...
export class ExtHostEmbeddings implements ExtHostEmbeddingsShape {
	...
	private readonly _provider = new Map<number, { id: string; provider: ProX-Code.EmbeddingsProvider }>();
	...
	registerEmbeddingsProvider(_extension: IExtensionDescription, embeddingsModel: string, provider: ProX-Code.EmbeddingsProvider): IDisposable {
	...
	async computeEmbeddings(embeddingsModel: string, input: string, token?: ProX-Code.CancellationToken): Promise<ProX-Code.Embedding>;
	async computeEmbeddings(embeddingsModel: string, input: string[], token?: ProX-Code.CancellationToken): Promise<ProX-Code.Embedding[]>;
	async computeEmbeddings(embeddingsModel: string, input: string | string[], token?: ProX-Code.CancellationToken): Promise<ProX-Code.Embedding[] | ProX-Code.Embedding> {
