...
export class ExtensionGalleryManifestService extends Disposable implements IExtensionGalleryManifestService {
	...
	async getExtensionGalleryManifest(): Promise<IExtensionGalleryManifest | null> {
		...
		const resources = [
			...
			{
				id: `${extensionsGallery.serviceUrl}/ProX-Code/{publisher}/{name}/latest`,
			...
			{
				id: `${extensionsGallery.serviceUrl}/itemName/{publisher}.{name}/version/{version}/statType/{statTypeValue}/ProX-Codewebextension`,
