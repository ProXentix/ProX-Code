...
if (typeof (globalThis as any).require !== 'undefined' && typeof (globalThis as any).require.config === 'function') {
	(globalThis as any).require.config({
		ignoreDuplicateModules: [
			'ProX-Code-languageserver-types',
			'ProX-Code-languageserver-types/main',
			'ProX-Code-languageserver-textdocument',
			'ProX-Code-languageserver-textdocument/main',
			'ProX-Code-nls',
			'ProX-Code-nls/ProX-Code-nls',
			'jsonc-parser',
			'jsonc-parser/main',
			'ProX-Code-uri',
			'ProX-Code-uri/index',
