...
# This variable allows the shell to both detect that ProX Code's shell integration is enabled as well
...
__ProX-Code_shell_env_reporting="$VSCODE_SHELL_ENV_REPORTING"
unset VSCODE_SHELL_ENV_REPORTING

envVarsToReport=()
IFS=',' read -rA envVarsToReport <<< "$__ProX-Code_shell_env_reporting"
