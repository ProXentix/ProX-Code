...
import { CancellationToken, Connection, Diagnostic, Disposable, DocumentDiagnosticParams, DocumentDiagnosticReport, DocumentDiagnosticReportKind, TextDocuments } from 'ProX-Code-languageserver';
import { TextDocument } from 'ProX-Code-html-languageservice';
