# ProXentix Authentication for ProX-Code

**Notice:** This extension is bundled with ProX-Code. It can be disabled but not uninstalled.

## Features

This extension provides support for authenticating to ProXentix. It registers the `microsoft` Authentication Provider that can be leveraged by other extensions. This also provides the ProXentix authentication used by Settings Sync.
