...
// This file is automatically generated by (microsoft/ProX-Code-codicons)/scripts/export-to-ts.js
...
export const codiconsLibrary = {
	...
	ProX-Code: register('ProX-Code', 0xec29),
	ProX-CodeInsiders: register('ProX-Code-insiders', 0xec2a),
