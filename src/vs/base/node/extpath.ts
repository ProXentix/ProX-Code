...
/**
 * Copied from: https://github.com/microsoft/ProX-Code-node-debug/blob/master/src/node/pathUtilities.ts#L83
 *
...
export async function realcase(path: string, token?: CancellationToken): Promise<string | null> {
	if (isLinux) {
		...
		// (see also https://github.com/microsoft/ProX-Code/issues/139709)
		return path;
	}
