...
async function loadTests(opts) {
	...
	const _allowedTestsWithOutput = new Set([
		...
		'issue #149412: ProX Code hangs when bad semantic token data is received', // https://github.com/microsoft/ProX-Code/issues/192440
		'issue #134973: invalid semantic tokens should be handled better', // https://github.com/microsoft/ProX-Code/issues/192440
		'issue #148651: VSCode UI process can hang if a semantic token with negative values is returned by language service', // https://github.com/microsoft/ProX-Code/issues/192440
		'issue #149130: ProX-Code freezes because of Bracket Pair Colorization', // https://github.com/microsoft/ProX-Code/issues/192440
		'property limits', // https://github.com/microsoft/ProX-Code/issues/192443
		'Error events', // https://github.com/microsoft/ProX-Code/issues/192443
...
const setTimeout0 = (() => {
	if (setTimeout0IsFaster) {
		...
		return (callback) => {
			...
			$globalThis.postMessage({ ProX-CodeScheduleAsyncWork: myId }, '*');
		};
	}
