...
namespace snippetExt {
	...
	export const snippetsContribution: IJSONSchema = {
		description: localize('ProX-Code.extension.contributes.snippets', 'Contributes snippets.'),
		type: 'array',
		...
		items: {
			...
			properties: {
				language: {
					description: localize('ProX-Code.extension.contributes.snippets-language', 'Language identifier for which this snippet is contributed to.'),
					type: 'string'
				},
				path: {
					description: localize('ProX-Code.extension.contributes.snippets-path', 'Path of the snippets file. The path is relative to the extension folder and typically starts with \'./snippets/\'.'),
					type: 'string'
				}
			}
		}
