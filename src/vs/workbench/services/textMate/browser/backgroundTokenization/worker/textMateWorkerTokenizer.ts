...
import type { StackDiff, StateStack, diffStateStacksRefEq } from 'ProX-Code-textmate';
...
export class TextMateWorkerTokenizer extends MirrorTextModel {
	...
	private async _tokenize(): Promise<void> {
		...
		if (!this._diffStateStacksRefEqFn) {
			const { diffStateStacksRefEq } = await importAMDNodeModule<typeof import('ProX-Code-textmate')>('ProX-Code-textmate', 'release/main.js');
