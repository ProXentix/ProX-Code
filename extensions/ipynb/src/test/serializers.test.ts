...
suite(`ipynb serializer`, () => {
	...
	test('Deserialize', async () => {
		...
		const expectedCodeCell = new ProX-Code.NotebookCellData(ProX-Code.NotebookCellKind.Code, 'print(1)', 'python');
		...
		const expectedCodeCell2 = new ProX-Code.NotebookCellData(ProX-Code.NotebookCellKind.Code, 'print(2)', 'python');
		expectedCodeCell2.outputs = [];
		expectedCodeCell2.metadata = { execution_count: null, metadata: {} };
		expectedCodeCell2.executionSummary = {};

		const expectedMarkdownCell = new ProX-Code.NotebookCellData(ProX-Code.NotebookCellKind.Markup, '# HEAD', 'markdown');
