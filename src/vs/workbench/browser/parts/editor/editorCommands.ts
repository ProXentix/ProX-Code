...
function registerEditorGroupsLayoutCommands(): void {
	...
	CommandsRegistry.registerCommand({
		...
		metadata: {
			...
			args: [],
			returns: 'An editor layout object, in the same format as ProX-Code.setEditorLayout'
		}
	});
}
...
function registerOpenEditorAPICommands(): void {
	...
	// complements https://github.com/microsoft/ProX-Code/blob/2b164efb0e6a5de3826bff62683eaeafe032284f/src/vs/workbench/api/common/extHostApiCommands.ts#L373
	CommandsRegistry.registerCommand({
		id: 'ProX-Code.open',
	...
	// complements https://github.com/microsoft/ProX-Code/blob/2b164efb0e6a5de3826bff62683eaeafe032284f/src/vs/workbench/api/common/extHostApiCommands.ts#L397
	CommandsRegistry.registerCommand({
		id: 'ProX-Code.diff',
