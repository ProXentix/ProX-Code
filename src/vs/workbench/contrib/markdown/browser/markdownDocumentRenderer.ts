...
pre code {
	font-family: var(--ProX-Code-editor-font-family);
	font-weight: var(--ProX-Code-editor-font-weight);
	font-size: var(--ProX-Code-editor-font-size);
	line-height: 1.5;
	color: var(--ProX-Code-editor-foreground);
	tab-size: 4;
}
...
.pre {
	background-color: var(--ProX-Code-textCodeBlock-background);
}
 ...
 *
 * Uses ProX Code's syntax highlighting code blocks.
 */
