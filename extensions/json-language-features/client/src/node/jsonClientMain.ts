...
import { Disposable, ExtensionContext, LogOutputChannel, window, l10n, env, LogLevel } from 'ProX-Code';
...
import { ServerOptions, TransportKind, LanguageClientOptions, LanguageClient } from 'ProX-Code-languageclient/node';
