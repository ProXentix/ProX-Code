...
https://experimentation.visualstudio.com/Analysis%20and%20Experimentation/_git/AnE.ExP.TAS.TachyonHost.Configuration?path=%2FConfigurations%2FProX-Code%2FProX-Code.json&version=GBmaster
...
export enum Filters {
	...
	/**
	 * The language in use by ProX Code
	 */
...
export class AssignmentFilterProvider implements IExperimentationFilterProvider {
	 ...
	 * Ref: https://github.com/microsoft/tas-client/blob/30340d5e1da37c2789049fcf45928b954680606f/ProX-Code-tas-client/src/ProX-Code-tas-client/VSCodeFilterProvider.ts#L35
	 *
	...
	getFilterValue(filter: string): string | null {
		switch (filter) {
			...
			case Filters.ExtensionName:
				return 'ProX-Code-core'; // always return ProX-Code-core for exp service
