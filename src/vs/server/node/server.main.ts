...
(global as unknown as { proxCodeServerCodeLoadedTime?: number }).proxCodeServerCodeLoadedTime = performance.now();
...
const REMOTE_DATA_FOLDER = args['server-data-dir'] || process.env['VSCODE_AGENT_FOLDER'] || join(os.homedir(), product.serverDataFolderName || '.prox-code-remote');
