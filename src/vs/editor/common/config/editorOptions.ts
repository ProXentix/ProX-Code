...
export interface IEditorOptions {
	...
	*/
	 ...
	 * Defaults to true in ProX-Code and to false in monaco-editor.
	 */
	glyphMargin?: boolean;
	/**
	 ...
	 * Defaults to 'same' in ProX-Code and to 'none' in monaco-editor.
	 */
...
export interface IUnicodeHighlightOptions {
	 ...
	 */
	allowedLocales?: Record<string | '_os' | '_ProX-Code', true>;
}
...
class UnicodeHighlight extends BaseEditorOption<EditorOption.unicodeHighlighting, IUnicodeHighlightOptions, InternalUnicodeHighlightOptions> {
	constructor() {
		const defaults: InternalUnicodeHighlightOptions = {
			...
			includeStrings: true,
			allowedCharacters: {},
			allowedLocales: { _os: true, _ProX-Code: true },
		};
