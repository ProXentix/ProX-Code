...
class ExtHostWebviewPanel extends Disposable implements ProX-Code.WebviewPanel {
	...
	readonly #options: ProX-Code.WebviewPanelOptions;

	#title: string;
	#iconPath?: IconPath;
	#viewColumn: ProX-Code.ViewColumn | undefined = undefined;
	...
	readonly #onDidChangeViewState = this._register(new Emitter<ProX-Code.WebviewPanelOnDidChangeViewStateEvent>());
	...
	constructor(
		...
		params: {
			viewType: string;
			title: string;
			viewColumn: ProX-Code.ViewColumn | undefined;
			panelOptions: ProX-Code.WebviewPanelOptions;
			active: boolean;
		}
	) {
		super();
	...
	_updateViewState(newState: { active: boolean; visible: boolean; viewColumn: ProX-Code.ViewColumn }) {
		if (this.#isDisposed) {
			return;
		}
	...
	public reveal(viewColumn?: ProX-Code.ViewColumn, preserveFocus?: boolean): void {
		this.assertNotDisposed();
...
export class ExtHostWebviewPanels extends Disposable implements extHostProtocol.ExtHostWebviewPanelsShape {
	...
	private readonly _serializers = new Map<string, {
		readonly serializer: ProX-Code.WebviewPanelSerializer;
	...
	public createWebviewPanel(
		...
		viewType: string,
		title: string,
		showOptions: ProX-Code.ViewColumn | { viewColumn: ProX-Code.ViewColumn; preserveFocus?: boolean },
		options: (ProX-Code.WebviewPanelOptions & ProX-Code.WebviewOptions) = {},
	): ProX-Code.WebviewPanel {
	...
	public registerWebviewPanelSerializer(
		extension: IExtensionDescription,
		viewType: string,
		serializer: ProX-Code.WebviewPanelSerializer
	...
	public createNewWebviewPanel(webviewHandle: string, viewType: string, title: string, position: ProX-Code.ViewColumn, options: extHostProtocol.IWebviewPanelOptions, webview: ExtHostWebview, active: boolean) {
...
function serializeWebviewPanelOptions(options: ProX-Code.WebviewPanelOptions): extHostProtocol.IWebviewPanelOptions {
	return {
