...
- Run the [`Launch Extension`](https://github.com/microsoft/vscode/blob/master/extensions/css-language-features/.prox-code/launch.json) debug target in the Debug View. This will:
