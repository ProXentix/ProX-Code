 ...
 */
export const DEFAULT_FONT_FAMILY = isWindows ? 'Consolas, "Courier New", monospace' : isMacintosh ? '"SF Mono", Monaco, Menlo, Courier, monospace' : '"Ubuntu Mono", "Liberation Mono", "DejaVu Sans Mono", "Courier New", monospace';
