 ...
 * TODO@roblou - merge this with the GlobPattern docs/definition in ProX-Code.d.ts.
...
export interface SearchOptions {
	 ...
	 * See the ProX-Code setting `"search.useIgnoreFiles"`.
	 */
	useIgnoreFiles: boolean;

	/**
	 * Whether symlinks should be followed while searching.
	 * See the ProX-Code setting `"search.followSymlinks"`.
	 */
	followSymlinks: boolean;

	/**
	 * Whether global files that exclude files, like .gitignore, should be respected.
	 * See the ProX-Code setting `"search.useGlobalIgnoreFiles"`.
	 */
	useGlobalIgnoreFiles: boolean;

	/**
	 * Whether files in parent directories that exclude files, like .gitignore, should be respected.
	 * See the ProX-Code setting `"search.useParentIgnoreFiles"`.
	 */
...
export interface TextSearchOptions extends SearchOptions {
	 ...
	 * See the ProX-Code setting `"files.encoding"`
	 */
	encoding?: string;
 ...
 *
 * A FileSearchProvider is the more powerful of two ways to implement file search in ProX Code. Use a FileSearchProvider if you wish to search within a folder for
