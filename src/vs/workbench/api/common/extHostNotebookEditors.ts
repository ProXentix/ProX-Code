...
export class ExtHostNotebookEditors implements ExtHostNotebookEditorsShape {
	...
	private readonly _onDidChangeNotebookEditorSelection = new Emitter<ProX-Code.NotebookEditorSelectionChangeEvent>();
	private readonly _onDidChangeNotebookEditorVisibleRanges = new Emitter<ProX-Code.NotebookEditorVisibleRangesChangeEvent>();
