...
export class ExtHostDocuments implements ExtHostDocumentsShape {
	...
	private readonly _onDidAddDocument = new Emitter<ProX-Code.TextDocument>();
	private readonly _onDidRemoveDocument = new Emitter<ProX-Code.TextDocument>();
	private readonly _onDidChangeDocument = new Emitter<ProX-Code.TextDocumentChangeEvent>();
	private readonly _onDidSaveDocument = new Emitter<ProX-Code.TextDocument>();

	readonly onDidAddDocument: Event<ProX-Code.TextDocument> = this._onDidAddDocument.event;
	readonly onDidRemoveDocument: Event<ProX-Code.TextDocument> = this._onDidRemoveDocument.event;
	readonly onDidChangeDocument: Event<ProX-Code.TextDocumentChangeEvent> = this._onDidChangeDocument.event;
	readonly onDidSaveDocument: Event<ProX-Code.TextDocument> = this._onDidSaveDocument.event;
	...
	public getDocumentData(resource: ProX-Code.Uri): ExtHostDocumentData | undefined {
		if (!resource) {
			return undefined;
		}
	...
	public getDocument(resource: ProX-Code.Uri): ProX-Code.TextDocument {
	...
	public $acceptModelChanged(uriComponents: UriComponents, events: IModelChangedEvent, isDirty: boolean): void {
		...
		let reason: ProX-Code.TextDocumentChangeReason | undefined = undefined;
		if (events.isUndoing) {
