...
import type { DocumentSelector } from 'ProX-Code';
...
// Copied from NotebookCellKind.Markup as we cannot import it from ProX-Code directly in worker threads.
export const NotebookCellKindMarkup = 1;
// Copied from NotebookCellKind.Code as we cannot import it from ProX-Code directly in worker threads.
