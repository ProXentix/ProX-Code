...
// #region
// https://github.com/microsoft/ProX-Code-js-profile-visualizer/blob/6e7401128ee860be113a916f80fcfe20ac99418e/packages/ProX-Code-js-profile-core/src/cpu/model.ts#L4
...
export const buildModel = (profile: ICpuProfileRaw): IProfileModel => {
	if (!profile.timeDeltas || !profile.samples) {
		return {
			...
			// rootPath: profile.$ProX-Code?.rootPath,
