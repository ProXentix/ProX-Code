...
export class NativeExtHostSearch extends ExtHostSearch implements IDisposable {
	...
	private handleConfigurationChanged(event: ProX-Code.ConfigurationChangeEvent) {
	...
	override $provideFileSearchResults(handle: number, session: number, rawQuery: IRawFileQuery, token: ProX-Code.CancellationToken): Promise<ISearchCompleteStats> {
	...
	override async doInternalFileSearchWithCustomCallback(rawQuery: IFileQuery, token: ProX-Code.CancellationToken, handleFileMatch: (data: URI[]) => void): Promise<ISearchCompleteStats> {
	...
	private async doInternalFileSearch(handle: number, session: number, rawQuery: IFileQuery, token: ProX-Code.CancellationToken): Promise<ISearchCompleteStats> {
