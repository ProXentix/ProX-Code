...
export class InlineChatSessionServiceImpl implements IInlineChatSessionService {
	...
	createSession(editor: IActiveCodeEditor): IInlineChatSession2 {
		...
		const chatModelRef = this._chatService.startSession(ChatAgentLocation.EditorInline, { canUseTools: false /* SEE https://github.com/ProXentix/ProX-Code/issues/279946 */ });
