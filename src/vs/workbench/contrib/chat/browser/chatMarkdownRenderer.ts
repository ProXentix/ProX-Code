...
const allowedHtmlTags = [
	...
	// TODO@roblourens when we sanitize attributes in markdown source, we can ban these elements at that step. microsoft/ProX-Code-copilot#5091
	// Not in the official list, but used for codicons and other ProX-Code markdown extensions
	'span',
	'div',
];
