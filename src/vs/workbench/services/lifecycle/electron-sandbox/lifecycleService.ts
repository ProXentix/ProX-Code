...
export class NativeLifecycleService extends AbstractLifecycleService {
	...
	private registerListeners(): void {
		...
		ipcRenderer.on('ProX-Code:onBeforeUnload', async (event: unknown, reply: { okChannel: string; cancelChannel: string; reason: ShutdownReason }) => {
		...
		ipcRenderer.on('ProX-Code:onWillUnload', async (event: unknown, reply: { replyChannel: string; reason: ShutdownReason }) => {
