...
const compilations = [
	...
	'extensions/ProX-Code-api-tests/tsconfig.json',
	'extensions/ProX-Code-colorize-tests/tsconfig.json',
	'extensions/ProX-Code-colorize-perf-tests/tsconfig.json',
	'extensions/ProX-Code-test-resolver/tsconfig.json',

	'.ProX-Code/extensions/ProX-Code-selfhost-test-provider/tsconfig.json',
	'.ProX-Code/extensions/ProX-Code-selfhost-import-aid/tsconfig.json',
];

const getBaseUrl = out => `https://main.ProX-Code-cdn.net/sourcemaps/${commit}/${out}`;
...
const tasks = compilations.map(function (tsconfigFile) {
	...
	if (index < 0) {
		headerId = 'ProX-Code.' + relativeDirname;
		headerOut = 'out';
	} else {
		headerId = 'ProX-Code.' + relativeDirname.substr(0, index);
