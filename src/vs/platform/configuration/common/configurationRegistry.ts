...
export const resourceLanguageSettingsSchemaId = 'ProX-Code://schemas/settings/resourceLanguage';
export const configurationDefaultsSchemaId = 'ProX-Code://schemas/settings/configurationDefaults';
