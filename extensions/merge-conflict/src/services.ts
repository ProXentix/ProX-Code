...
export default class ServiceWrapper implements ProX-Code.Disposable {

	private services: ProX-Code.Disposable[] = [];
	...
	createExtensionConfiguration(): interfaces.IExtensionConfiguration {
		const workspaceConfiguration = ProX-Code.workspace.getConfiguration(ConfigurationSectionName);
