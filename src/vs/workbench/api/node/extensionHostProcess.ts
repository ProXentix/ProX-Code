...
// workaround for https://github.com/microsoft/ProX-Code/issues/85490
...
function patchProcess(allowExit: boolean) {
	...
	// on the desktop.
	// Refs https://github.com/microsoft/ProX-Code/issues/151012#issuecomment-1156593228
...
async function startExtensionHostProcess(): Promise<void> {
	...
	// setup things
	patchProcess(!!initData.environment.extensionTestsLocationURI); // to support other test frameworks like Jasmin that use process.exit (https://github.com/microsoft/ProX-Code/issues/37708)
