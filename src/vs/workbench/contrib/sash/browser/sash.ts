...
export class SashSettingsController implements IWorkbenchContribution, IDisposable {
	...
	private onDidChangeSize(): void {
		...
		this.layoutService.mainContainer.style.setProperty('--ProX-Code-sash-size', size + 'px');
		this.layoutService.mainContainer.style.setProperty('--ProX-Code-sash-hover-size', hoverSize + 'px');
