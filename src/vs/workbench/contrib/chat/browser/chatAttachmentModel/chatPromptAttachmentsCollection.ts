 ...
 */
const PROMPT_VARIABLE_ID_PREFIX = 'ProX-Code.prompt.instructions';
 ...
 *
 * - `ProX-Code.prompt.instructions__<URI>`: for all non-root prompt file references
 * - `ProX-Code.prompt.instructions.root__<URI>`: for *root* prompt file references
