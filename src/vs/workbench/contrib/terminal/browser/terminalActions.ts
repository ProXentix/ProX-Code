...
export const terminalSendSequenceCommand = async (accessor: ServicesAccessor, args: unknown) => {
	...
	if (instance) {
		...
		const activeWorkspaceRootUri = historyService.getLastActiveWorkspaceRoot(instance.isRemote ? Schemas.ProX-CodeRemote : Schemas.file);
...
export class TerminalLaunchHelpAction extends Action {
	...
	override async run(): Promise<void> {
		this._openerService.open('https://aka.ms/ProX-Code-troubleshoot-terminal-launch');
	}
}
...
export function registerTerminalActions() {
	...
	registerActiveXtermAction({
		...
		keybinding: [{
			...
			// behavior anyway when handed to xterm.js, having this handled by ProX Code
